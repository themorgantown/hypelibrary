...
n.HYPE_550=function($,H,U,jc,Of,Pf,Wa,t,pb,ek,vd,wd,lk,Qf,ne,xd,fk,gk,Ic){function Rf(a,b,c){Jc!=j&&(a={element:a,triggerOnce:k,elementOffset:0},a[c]=function(){b()},c=new Jc.hypeS(a),yd[A](c))}function X(a,b){return function(c){for(var d=0;d<b[D];d++){var e=b[d],f=e.p;if(1==f){var h=e.f,f=e.g,l=e.d;if(h==j||0==h){a:{for(h=0;h<Wa[D];h++)if(Wa[h].o==e.e){e=h;break a}e=-1}Hb(e,f,l)}else 1==h?Sf(f,l):2==h?Tf(f,l):3==h?Hb(0,f,l):4==h&&Hb(Wa[D]-1,f,l)}else if(3==f)e.b!=j&&(f=e.z!=aa?e.z:k,qb(e.b,a!=j?
...
rj,V));ue(O[a.id])}function Ya(a){Ib[a.id]=j;oc(a)}function oc(a){try{if(Dd==g)Nc[a.id]=a;else{var b=v(a,Bh,36),c=se(a),d=O[a.id],e=ve(d),f=$f(e),h=ag(e),l=$f(d),m=v(a,W,0),s=v(a,lh,0),p=v(a,Ph,j),u=v(a,gi,j),Cd=e=g;p==j&&(e=k,p=l[Ba]);u==j&&(Cd=k,u=l[Rb]);var w=Oc(d),C=Pc(d),d=C-u,l=m,P=s,t=w,M=C,y=k;if(mc==g&&36!=b){var r=0!=(b&1),Jb=0!=(b&4),H=0!=(b&2),Na=0!=(b&8),G=0!=(b&32),E=0!=(b&16),K=0!=(b&64)&&H==g&&E==g,F=0!=(b&128)&&H==g&&E==g,y=0!=(b&256)&&(H==g||E==g),Q=h[Ba]/f[Ba],R=h[Rb]/f[Rb];H==
g&&(t=r==g&&Jb==g?w+(h[Ba]-f[Ba]):z[Ga](w*Q));r==g&&Jb==g&&H==k?(b=m+w/2,l=z[Ga](b*Q-w/2)):r==g&&Jb==k&&H==g?l=h[Ba]-f[Ba]+m-(t-w):r==g&&Jb==k?l=h[Ba]-f[Ba]+m:r==k&&Jb==k&&(l=z[Ga](m*Q));E==g&&(M=Na==g&&G==g?C+(h[Rb]-f[Rb]):z[Ga](C*R));Na==g&&G==g&&E==k?P=z[Ga]((s+C/2)*R-C/2):Na==g&&G==k&&E==g?P=h[Rb]-f[Rb]+s-(M-C):Na==g&&G==k?P=h[Rb]-f[Rb]+s:Na==k&&G==k&&(P=z[Ga](s*R));if((K==g||F==g)==g)h=t,f=M,s=t/w,Q=M/C,R=s,K==g?R=s<=Q?s:Q:F==g&&(R=s>=Q?s:Q),t=z[Ga](w*R),M=z[Ga](C*R),K=h-t,F=f-M,r==g&&Jb==k?
l+=K:r==g&&Jb==g&&(l+=z[Ga](K/2)),Na==g&&G==k?P+=F:Na==g&&G==g&&(P+=z[Ga](F/2))}var X=z.max(0,t-(w-p)),I=z.max(0,M-d);e==g?(y==g&&(l+=v(a,Hj,0.5)*(t-w),Xa(a,kf,z.max(0,t/w)),X=p),ia(a[L],x(X,2))):ia(a[L],V);Cd==g?(y==g&&(P+=v(a,Ij,0.5)*(M-C),Xa(a,lf,z.max(0,M/C)),I=u),ta(a[L],x(I,2))):ta(a[L],V);Xa(a,cf,P);Xa(a,df,l);c==k&&(a[L].top=x(P),a[L].left=x(l));(c==g||y==g)&&Mc(a);we==k&&bg()}}catch(Z){}}function Uf(a){a!=j&&0===a[Ma]($j)&&(a=Ci+a);return a}function eb(a,b){if(a[Ma])return a[Ma](b);for(var c=
0;c<a[D];c++)if(a[c]==b)return c;return-1}function cg(a){return typeof a==Ej&&(7==a[D]&&a[Ka](0)==fc||0==a[Ma](tj)&&a[Ma](Dc)==a[D]-1)}function dg(a,b,c){var d=c.$,e=Za(a,c),f=a.d,h=a.i,l=a.o,m=d==k?a.b:j,s=m==j?c.$?a.e:a.s:m,m=d==g?a.b:j,p=m==j?c.$?a.s:a.e:m,u=a.f,m=sa(l),e=z.min(1,(b-e)/f);d==g&&(e=1-e);b=1;if(u==W)b=1==e?1:0;else if(u==lh)b=e;else a:{b=eg[u];for(var t=f=j,u=0;u<b[D];u++){for(var w=b[u],C=0;C<w.ca[D];C++){t=w.ca[C];if(t[vb].x>=e){b=f!=j?f[vb].y+(t[vb].y-f[vb].y)*(e-f[vb].x)/(t[vb].x-
f[vb].x):t[vb].y;break a}f=t}f=j}b=t[vb].y}e=d==k?s:p;f=a.a;if(f!=aa){d=xe[f];if(a.b!=j){if(c.Ua[f]==j&&(d=a.o,s=a.a,s!=aa)){p=xe[s];a={};for(var u=[],P=t=0,w=0;w<p.ka[D];w++){C=p.ka[w];if(0==w)var t=Oc(d),P=Pc(d),ra=K[d].b,t=K[d].a+t/2-C.ta.x,P=ra+P/2-C.ta.y;u[A]({ta:{x:C.ta.x+t,y:C.ta.y+P},Ga:{x:C.Ga.x+t,y:C.Ga.y+P},Ba:{x:C.Ba.x,y:C.Ba.y},Ja:{x:C.Ja.x,y:C.Ja.y},length:0,ca:[]});P=t=0}a.ka=u;na(a,ye(a.ka,g));c.Ua[s]=a;s=sa(d);if(v(s,yh)==Jf){for(var M,s=0;s<c.ea[D];s++)if(p=c.ea[s],p.i==xh){M=p;
...
b){var l=e=f=j,m=1,s=b;if(0>b){var p=a.ka[0];2<=p.ca[D]&&(f=p.ca[0],e=p.ca[1],l=f)}else m=-1,s=1-b,p=a.ka[a.ka[D]-1],2<=p.ca[D]&&(f=p.ca[p.ca[D]-2],l=e=p.ca[p.ca[D]-1]);if(f!=j&&e!=j){a=m*(e[vb].x-f[vb].x);b=m*(e[vb].y-f[vb].y);d*=s;0==b?(h.y=0,h.x=d):(h.y=z.sqrt(z.pow(d,2)/(z.pow(a,2)/z.pow(b,2)+1)),h.x=h.y*a/b);if(0<a&&0<h.x||0>a&&0>h.x)h.x*=-1;if(0<b&&0<h.y||0>b&&0>h.y)h.y*=-1;h.x+=l[vb].x;h.y+=l[vb].y;h.za=ig(f[vb],e[vb])}}else if(0==d)h={x:a.ka[0].ta.x,y:a.ka[0].ta.y,za:0};else{if(1==b)d=a.ka,
f=d[d[D]-1],h=1;else{for(h=0;h<a.ka[D];h++){p=a.ka[h];if((p[D]+e)/d>b){f=p;break}e+=p[D]}h=(b-e/d)/(f[D]/d);d=f[D]*h;for(b=a=h=0;b<f.ca[D];b++)if(e=f.ca[b],a+e[D]<=d)a+=e[D],h=b;else break;h=(h+(d-a)/(h+1<f.ca[D]?f.ca[h+1]:f.ca[f.ca[D]-1])[D])/(f.ca[D]-1)}h=jg(f,h)}d=h;d.x-=Oc(c)/2;d.y-=Pc(c)/2;return d}function Pc(a){a=sa(a);var b=v(a,gi,0),c=0;0==b?b=a.clientHeight:c=v(a,Xg,0)+v(a,Ug,0);return b+c+(v(a,Bf,0)+v(a,vf,0))}function Oc(a){a=sa(a);var b=v(a,Ph,0),c=0;0==b?b=a.clientWidth:c=v(a,Vg,0)+
...
0!=h[D]){for(d=0;d<b.qa[D];d++){var m=b.qa[d],e=m.b,l=ca(e),f=b.$==k?Y(m[Gb]+m[nb],b):Y(c-m[Gb],b);if(a>=f){if(pc[e]==b.aa){var s=b.$==k?m.G:Y(m.G+m[nb],l),f=0,f=m.z?s-m[nb]:s+m[nb],f=z.max(0,f);qc(l,k);f=Kb(f,l,g,g,k);f==k&&rb(e,j)}b.qa[Sb](d,1);d--}}for(d=b.ya;d<h[D];d++)if(m=h[d],e=m.b,l=ca(e),l!=j&&(f=b.$==k?m[Gb]:Y(c-m[Gb]-m[nb],b),a>=f)){b.ya=d+1;var p=m.z,u=m.E,v=s=b.$==k?m.G:Y(m.G+m[nb],l),w=k;b.$==g&&(p=!p);u&&(f=a-f,f>m[nb]?(u=k,f=m[nb]):(b.qa[A](m),w=g),v=p?v-f:v+f,v=z.max(0,v));if(u){if(f=
sb(s,e,g,g))continue;p&&(qc(l,p),v=Y(S(l)-v,l));if(f=sb(v,e,g,g))continue;b.fa?(Qc(l,b.ha),Kc(e,p,k,k)):rb(e,j)}else rb(e,j),sb(v,e,k,g);w&&(pc[e]=b.aa)}}}function Kb(a,b,c,d,e){Dd=g;var f=b.da,h=b.$?b.Na:b.ea,l=[];a=z.min(a*b.ha,S(b));for(var m=b.sa;m<h[D];m++){var s=h[m],p=Za(s,b);2==s.p&&((b.fa==g||e==g)&&a>=p)&&l[A](s)}e=k;if(0==l[D]||d==k)ze(a,b,h);else{for(var s=d=0,u=b.fa,t=b.$,m=0;m<l[D];m++){var v=l[m],p=Za(v,b);if(e==g&&d<p)break;if(!(c==k&&p!=a)){if(0==s||s!=p)ze(p,b,h),s=p;for(var v=v.s.a,
C=[],P=k,ra=0;ra<v[D];ra++){var M=v[ra];7==M.p&&M.b==b.aa&&(M.r=p,P=g);0==p&&3==M.p&&M.b==b.aa||C[A](M)}if(0!=C[D]){var y;b.Ha[J](Ph)&&(y=b.Ha.c);var r;y?tb[J](y)?r=tb[y][Fb]():R[J](y)&&(r=R[y][Fb]):r=ya();X(r,C)({type:sf,timelineName:b.Ha.n})}if(f!=b.da||-1==eb(Fa,b)||b.da==j||u!=b.fa||P||t!=b.$)e=g,d=p}}e==k&&ze(a,b,h)}kg();return e}function Za(a,b){return b.$?Y(S(b)-a.d-a.t,b):a.t}function lg(){for(var a,b=Pa()/1E3,c=0;c<Fa[D];c++){var d=Fa[c];if(!(-1==eb(Fa,d)||d.da==j||d.fa==k||d.Ta==g)){var e=
b-d.da,f=d.$?d.Na:d.ea;Kb(e,d,g,g)&&(e=b-d.da);if(-1!=eb(Fa,d)){var h=S(d);if(e<=h){if(0<d.ia[D])a=0;else if(d.sa<f[D]&&(f=Y((Za(f[d.sa],d)-e*d.ha)/d.ha,d),a==j||f<a))a=f;f=d.$==k?d.Oa:d.Va;if(0<d.qa[D])a=0;else if(d.ya<f[D]&&(f=f[d.ya],f=Y(((d.$==k?f[Gb]:Y(h-f[Gb]-f[nb],d))-e*d.ha)/d.ha,d),f<a||a==j))a=f}}}}0===a?Ed():a!=j&&n[lb](function(){Fd=k;lg()},1E3*a)}function mg(a){a=a.Oa;var b=[];if(a!=j)for(var c=0;c<a[D];c++){var d=a[c].b,e=ca(d);e==j||-1!=eb(b,d)||(rc(e),sb(0,d,k,g),b[A](d))}}function sb(a,
b,c,d){pc[b]=j;var e=ca(b);if(e!=j)return Qc(e,1),-1==eb(Fa,e)&&(rb(b),Fa[A](e)),b=S(e),a>b&&(a=b),e.$==g&&(a=b-a),d==g&&(a=Y(a,e)),e.sa=0,e.ya=0,e.ia=[],e.qa=[],d=Pa()/1E3,e.da=d-a,e.ma=d-e.da,e.fa==g&&(n[xa](e.ua),e.ua=n[lb](function(){Rc(e)},1E3*((b-a)/e.ha))),ng(e,k),mg(e),Ae(e,0),og(e,a),a=Kb(a,e,k,g,c),Ed(),a}function sc(a,b){var c=ca(a);if(c==j)return 0;var d=0;c.fa==g?(d=Pa()/1E3-c.da,d*=c.ha):d=c.ma;var e=S(c);b==g&&c.$==g&&(d=e-d);d=z.max(0,d);return d=z.min(e,d)}function og(a,b){for(var c=
...
e.ha,e,k,k),Ed()):(d==g||0==e.ma)&&qb(a,j,b)))}function rb(a,b){pc[a]=j;var c=ca(a);c!=j&&c.fa==g&&(Qc(c,1),c.ma=b!=j?b:Pa()/1E3-c.da,c.fa=k,n[xa](c.ua))}function Rc(a){if(!Kb(S(a),a,g,g))if(rc(a),Sc!=j&&Gd==a.aa)a=Sc,Gd=Sc=j,a();else if(a={type:tf,timelineName:a.Ha.n},Tc(a,j)!==k){var b=ya();if(b!=j){var c=t[Hd(Id())].F;c!=j&&X(b,c.a)(a)}}}function Y(a,b){return Be(a,b.Ha.f)}function Be(a,b){var c=z.floor(a);return c+z[Ca]((a-c)*b)/b}function S(a){return Y(a.Ha.d,a)}function Ed(){if(Fd!==g){Fd=g;
var a=function(a){n[lb](a,1E3/60)};(y.va!=j?a:n.requestAnimationFrame||n.webkitRequestAnimationFrame||n.mozRequestAnimationFrame||a)(function(){Fd=k;lg()})}}function rc(a){n[xa](a.ua);a.sa=0;a.ya=0;a.ia=[];a.qa=[];a.Fb=j;a.da=j;a.fa=k;a.ha=1;a.ma=S(a);a=eb(Fa,a);-1!=a&&Fa[Sb](a,1)}function pg(a){for(var b=0;b<Fa[D];b++){var c=Fa[b];if(!(a!=j&&c.aa==a.aa))for(var d=0;d<c.ia[D];d++)Oa[c.ia[d].o][c.ia[d].i]!=c.aa&&(c.ia[Sb](d,1),d--)}}function Ae(a,b){for(var c=a.ea,d=0;d<c[D];d++){var e=c[d],f=e.o,
h=e.i,e=Y(Za(e,a)+e.d,a);Oa[f]===aa&&(Oa[f]={});if(e>=b&&(Ia[f]===aa||Ia[f][h]===aa||Ia[f][h]==a.aa))Oa[f][h]=a.aa}pg(a)}function qb(a,b,c){pc[a]=j;for(var d=0;d<Qa[D];d++){var e=Qa[d];e.aa==a&&rc(e)}var f=ca(a);if(f!=j)if(f.Fb=b,Fa[A](f),t[E].T[f.aa]==j&&f.nb==aa&&f.Ta!=g)Rc(f);else if(f.Ta!=g&&(ng(f,c==k),qc(f,c),Ae(f,0),og(f,0)),f.fa=g,f.sa=0,f.ya=0,f.ia=[],f.qa=[],f.Ua={},f.da=Pa()/1E3,n[xa](f.ua),f.ua=n[lb](function(){Rc(f)},1E3*(S(f)/f.ha)),mg(f),f.Ta==g||0<f.ea[D]||0<f.Oa[D])Kb(0,f,g,g,k),
Ed()}function ng(a,b){for(var c=0;c<a.ea[D];c++){var d=a.ea[c].o,e=a.ea[c].i,f=a.ea[c].r;try{if(f==g&&K[d][e]!=j&&(b||a.ea[c].b==j))a.ea[c].b=K[d][e]}catch(h){}}}function ca(a){for(var b=0;b<Qa[D];b++){var c=Qa[b];if(c.aa==a)return c}for(var d in R)if(R[J](d)!=k)for(var e=R[d].sb,b=0;b<e[D];b++)if(c=e[b],c.aa==a)return c;return j}function ub(a){var b=t[E].T,c;for(c in b)if(b[J](c)!=k&&b[c].n==a){var d=k,e=t[E].U,f;for(f in e)if(e[J](f)!=k){var h=e[f].V;for(a in h)if(h[J](a)!=k&&h[a]==c){d=g;break}if(d==
g)break}if(d==k)return c}return j}function Jd(a,b,c,d){b={sa:0,ia:[],ea:b,aa:a,Oa:c.b,fa:k,ma:0,ha:1,$:k,qa:[],nb:d,Ha:c,Ua:{}};for(c=0;c<Qa[D];c++)Qa[c].aa==a&&(rc(Qa[c]),Qa[Sb](c,1),c-=1);Qa[A](b);return b}function qc(a,b){var c=sc(a.aa,k);if(b!=a.$){a.$=b;b==g&&a.Na==j&&(a.Na=a.ea[Da](0),a.Na.sort(function(b,c){var d=Za(b,a),l=Za(c,a);return d==l?c.k-b.k:d-l}));b==g&&a.Va==j&&(a.Va=a.Oa[Da](0),a.Va.sort(function(b,c){var d=Y(b[Gb]+b[nb],a),l=Y(c[Gb]+c[nb],a);return d==l?(d=b[Gb],l=c[Gb],d==l?c.F-
b.F:l-d):l-d}));var d=S(a);a.ia=[];a.sa=0;a.ya=0;a.qa=[];a.ma=Y(d-a.ma,a);qg(a,d-c);a.da!=j&&Kb(Y(Pa()/1E3-a.da,a),a,k,k)}}function Qc(a,b){if(a.ha!=b){var c=sc(a.aa,k);a.ha=b;qg(a,c)}}function qg(a,b){a.da!=j&&(a.da=Pa()/1E3-b/a.ha,a.fa==g&&(n[xa](a.ua),a.ua=n[lb](function(){Rc(a)},1E3*((S(a)-b)/a.ha))))}function rg(a,b){var c=ub(a);c==j&&(c=Mi);b==aa&&(b=0);qb(c,j,1==b?g:k)}function pe(a,b,c){b=t[E].T[b];if(b!=j){b=b.a;for(var d=sa(c),e=0;e<b[D];e++){var f=b[e];if(f.o==c){var f=f.i,h=Ce[c];h!=j&&
h[f]!=j&&(Q(d,f,h[f]),h[f]=j)}}a=a?a:n[Tb];if(a[ab]==cj||a[ab]==nj||a[ab]==wf)b=t[E].v[c].aM,b!=j&&Wf(a,b,c)}}function Wf(a,b,c){var d=t[E].T[b];if(d!=j){var d=d.a,e=sa(c),f=t[E].v[c].aM;f!=j&&f!=b&&pe(a,f,c);var h=t[E].v[c].aN;a=a?a:n[Tb];a[ab]!=cj&&(a[ab]!=nj&&a[ab]!=wf&&h!=j&&h!=b&&f!=b)&&pe(a,h,c);for(a=0;a<d[D];a++)f=d[a],f.o==c&&(b=f.i,f=f.e,f!=j&&(h=Ce[c],h==j&&(h={},Ce[c]=h),h[b]==j&&(h[b]=K[c][b]),Q(e,b,f)))}}function Q(a){for(var b=arguments,c=1;c<b[D];c+=2){var d=b[c],e=b[c+1];if("undefined"!=
typeof e)try{var f=De[d];f!=j&&(K[O[a.id]][d]=e,f(a,e))}catch(h){n[Eb]&&n[Eb].log(ge+d+ce+e+Xb+h)}}}function x(a,b){var c=z.pow(10,b==j?0:b);return V+z[Ca](a*c)/c+pj}function hg(a){var b=[0,0,0,1];if(0==a[Ma](tj)){var c=a[Ma](Cc),d=a[Ma](Dc);if(3<d-c){a=a.substring(c+1,d).split(Fc);for(c=0;c<a[D];c++)b[c]=ha(a[c])}}else{a[Ka](0)==fc&&(a=a[Da](1));a=a.toUpperCase();d=da.Ya;for(c=0;3>c;c++)b[c]=16*d[Ma](a[Ka](2*c))+d[Ma](a[Ka](2*c+1))}return b}function gg(a){typeof a!=ij&&(a=ha(a));return isNaN(a)?
0:a}function sg(a,b,c){Kd=k;c!=j&&delete t[E].T[c];qa(b[L],Hh);Q(b,zh,0,$g,0);Xa(b,hf,nd);Q(b,lh,0,W,0,bk,1,mi,1);c=t[E].a;c!=j?(ia(b[L],sd),ia(G[L],c+gc)):(ia(b[L],x(t[E].Y)),ia(G[L],b[L][Ba]));c=t[E].b;c!=j?(ta(b[L],sd),ta(G[L],c+gc)):(ta(b[L],x(t[E].Z)),ta(G[L],b[L][Rb]));Ib[G.id]=j;Ib[b.id]=j;K[O[a.id]]&&(a!=j&&a!=b)&&(qa(a[L],hj),a[B](gh,g),Q(a,zh,0,$g,0,lh,0,W,0,bk,0,mi,1),Xa(a,hf,nd));G[L][gd]=j;G[L][da.la+Sj]=xi;G[L][bd]=j;G[L].perspective=j;c=[];a=t[E].v;for(var d in a)if(a[J](d)!=k){var e=
a[d],f=e.cL;if(f){c[A](f);var h=R[f][Fb];K[O[h.id]]=j;var l=q[Ta](e.k);oa(l,e.cP?Xe+e.cP:We);l.id=h.id;l[L].pointerEvents=kh;for(l[L][mj]=kh;0<h.childNodes[D];)l[ua](h.childNodes[0]);h[Qb][ua](l);h[Qb][zb](h);h=l;l=R[f].element=h;if(l[Qb][kb]==Ze){var l=l[Qb],m=l[L];if(e.bR!=j||e.aY!=j){var s=t[E].p;m[gd]=s;pa(m,s);m.perspective=s}else m[gd]=V,pa(m,V),m.perspective=V}b[ua](l);Ee(e,h,h.id,k);e=Ld(h);for(h=0;h<e[D];h++){m=e[h];l=a[O[m.id]];for(s=0;2>s;s++)for(var p=0;p<Uc[D];p++){var u=Uc[p];if(l[J](u)!=
k){var y=0==s?k:g;if(u==Sg||u==Tg)y=0==s?g:k;y!=k&&Q(m,u,l[u])}}}f=R[f].sb;for(h=0;h<f[D];h++)Qa[A](f[h])}}f=q[Ha]($e);for(d in R)if(R[J](d)!=k){e=k;for(h=0;h<c[D];h++)if(c[h]===d){e=g;break}e==k&&(h=R[d][Fb],h[Qb][kb]==Ze&&(h=h[Qb]),f[ua](h))}d=t[E].O;for(c=0;c<d[D]-1;c++)e=sa(d[c]),e[B](fh,Lb[d[c+1]]);b[B](fh,Lb[d[0]]);G[B](gh,k);G.removeAttribute(eh);b[B](gh,k);qb(Mi,j,k);d=Ld(ya());for(h=0;h<d[D];h++){e=d[h];if(f=a[O[e.id]].cL){c=R[f];if(c.zb)continue;c.zb=g}(c=v(e,Vh))&&X(e,c.a)({type:qf})}a=
{type:nf};Tc(a,j)!==k&&(d=t[Hd(O[b.id])].A,d!=j&&(d=d.a,X(ya(),d)(a)));b=tg(b);for(a=0;a<b[D];a++)if(d=b[a],c=q[Ha](d),d=t[E].v[O[d]],d!=j)for(f=0;f<Md[D];f++)h=Md[f],d[J](h)!=k&&Q(c,h,d[h])}function ug(a,b){var c=tg(a);Dd=g;for(var d=0;d<c[D];d++){var e=c[d],f=q[Ha](e),h=t[E].v[O[e]];h!=j&&Ee(h,f,e,b)}kg()}function tg(a){a=Ld(a);for(var b=[],c=0;c<a[D];c++)b[A](a[c].id);return b}function Ee(a,b,c,d){var e=[ph,Bh,lh,W,Ph,gi,Li],f=O[c];K[f]==j&&(K[f]={});var h=t[E].U[O[c]];h&&(tb[O[c]]={symbolName:function(){return h.n},
...
Oj&&0<a[db][D]&&Nd(a[db][0]);if(d==g&&(a[ab]==Yi||a[ab]==cj||a[ab]==Oj)){if(0<Rd)return;Sd=g}c(a)}if(a==di||a==cj)a=n.navigator.Ib?nj:n.navigator.msPointerEnabled?wf:cj;za(a,f,b,g);a==di?za(Oi,e,b,g):a==Zi?za(Ni,e,b,g):a==cj&&za(Pi,e,b,g)}function Aa(a,b,c,d){Fe(a,b,c,d);a==bj?Fe(aj,b,function(){},d):a==aj&&Fe(bj,b,function(){},d)}function Mb(a,b,c){c={Ea:j,xa:qi,La:0,Ca:j,Ra:0,tb:0,Za:0,ob:0,kb:0,lb:0,cb:j,bb:j,ja:j,ga:k,Xa:k,options:b,eb:c,jb:a};za(Qj,xg(c),a,g);if(b.ba==ki||b.ba==Gj){var d=a==
q?G:a;d[L].msTouchAction=hj;d[L].Jb=hj}b.ba!=Kj&&za(Zi,xg(c),a,g)}function yg(a,b){for(var c={Da:1,wb:g,ba:ki},d=b.a,e=g,f=0;f<d[D];f++){var h=d[f],l=h.p;0!=l&&(e=k);10==l&&h.b!=j?(c.pa==j&&(c.pa=[]),c.pa[A]({b:h.b,c:h.c,A:h.A,y:h.y,K:100/h.K})):11==l&&(c.Ia=a)}e==k&&Mb(a,c,X(a,d))}function xg(a){return function(b){a.ga=b[ab]==Qj;a.ga&&(0<b[wb][D]&&a[N].ba==Kj&&Nd(b[wb][0]),a.La=b[wb][D]);(a[N].ba==ki||a[N].ba==Gj)&&b[La]&&b[La]();if(a.ga==k||1===a.La){a.xa=Dj;a.Ea=j;for(var c=[],d=0;5>=d;d++)c[A]({start:{x:0,
y:0},end:{x:0,y:0},lastPosition:{x:0,y:0}});a.Ca=c;a.Fa=aa;a.Xa=k;var c=a.ga?b[wb][0]:b,e;e=function(b){Ge(a);a.xa=ai;Td(b,a)};a.ja=e;b=a.ga?a.jb:q;a.ga?za(Nj,a.ja,b,k):n.self!=n.top&&(d=function(a){(a.relatedTarget===q.documentElement||a.toElement===j)&&e(a)},a.ja=d,za(aj,d,b,k));c=Od(c);d=a.Ca[0];d[Bb].x=c.x;d.end.x=c.x;d[wa].x=c.x;d[Bb].y=c.y;d.end.y=c.y;d[wa].y=c.y;zg(a,c);a.cb=function(b){if(!(a.xa===qi||a.xa===ai))if(Sd==g)a.ja(b);else{if(a.Sa==k&&(Rd++,a.Sa=g,a[N].ba==ki)){Ud=g;if(a[N].pa!=
j)for(var c=0;c<a[N].pa[D];c++){var d=a[N].pa[c].b,e=ca(d);rb(d,j);qc(e,k);a.tb=sc(e.aa,k);for(var s=e.ea,p=0;p<s[D];p++){var d=s[p].o,u=s[p].i;Ia[d]===aa&&(Ia[d]={});Ia[d][u]=e.aa}}a[N].Ia!=j&&(c=O[a[N].Ia.id],a.kb=K[c].a,a.lb=K[c].b,Oa[c]!=aa&&(Oa[c].a=j,Oa[c].b=j,pg(j)),Ia[c]===aa&&(Ia[c]={}),Ia[c].a=ni,Ia[c].b=ni);Td(b,a)}s=Od(a.ga?b[wb][0]:b);p=a.Ca[0];p[wa].x=p.end.x;p[wa].y=p.end.y;a.Za=a.ob;p.end.x=a.ga?b[wb][0].pageX:s.x;p.end.y=a.ga?b[wb][0].pageY:s.y;c=Pa();a.ob=c;c-=a.Ra;a.Ea=Ag(p[Bb],
p.end,c);a.ga&&(a.La=b[wb][D]);a.xa=dj;if(a[N].ba==ki){b[La]&&b[La]();if(a[N].pa!=j)for(c=0;c<a[N].pa[D];c++)if(u=a[N].pa[c],d=u.b,e=ca(d)){var e=S(e),t=Bg(u),w;t==wj?w=p.end.x-p[Bb].x:t==Ri?w=p[Bb].x-p.end.x:t==Uj?w=p[Bb].y-p.end.y:t==ji&&(w=p.end.y-p[Bb].y);u=w/u.K;u+=a.tb;u=z.min(e,u);u=z.max(0,u);sb(u,d,k,g)}else a.ja(b);if(a[N].Ia!=j){c=O[a[N].Ia.id];u=ve(c);w=e=0;for(t=d=1;u!=j&&u!=H;){var C=sa(u),e=e+v(C,W,0);w+=v(C,lh,0);d*=v(C,Wh,1);t*=v(C,Xh,1);u=ve(u)}d=a.kb+(p.end.x-p[Bb].x)/d;p=a.lb+
(p.end.y-p[Bb].y)/t;mc==k&&(u=ag(u),t=Oc(c),d=z.max(d,-t/2-e),d=z.min(d,u[Ba]-t/2-e),c=Pc(c),p=z.max(p,-c/2-w),p=z.min(p,u[Rb]-c/2-w));Q(a[N].Ia,W,d,lh,p)}Td(b,a)}else a[N].ba==Gj?1<a.La?a.ja(b):(b[La]&&a.Ea==a[N][va]&&b[La](),w=a[N][va]==wj||a[N][va]==Ri?p.end.x:p.end.y,p=k,p=a[N][va]==wj||a[N][va]==ji?20<a.Fa-w:20<w-a.Fa,w=a.Ea===a[N][va]||100>c,(p||w==k||Ud==g)&&a.ja(b)):a[N].ba==Kj&&5<He(p[Bb],p.end)&&a.ja(b);zg(a,s)}};za(a.ga?Pj:$i,a.cb,b,k);a.bb=function(b){if(!(a.xa===qi||a.xa===ai)&&!(b[wb]&&
0<b[wb][D]))if(Sd==g&&0<Rd)a.ja(b);else{b[ab]==Oj&&0<b[db][D]&&a[N][ab]==Kj&&Nd(b[db][0]);var c=Pa(),d=c-a.Ra,e=a.Ca[0];a.Ea=Ag(e[Bb],e.end,d);a.xa=qi;var t=1===a.La||!a.ga,p=0!==e.end.x;if(a[N].ba==ki){if(a.Sa==k){Ge(a);return}Ia={};if(a[N].pa!=j){t=(c-a.Za)/1E3;for(p=0;p<a[N].pa[D];p++){var u=a[N].pa[p],c=u.b,d=ca(c),v=u.y;if(d){var w=S(d),C=Bg(u),P=u.K,y=k,M=k,H=1;if(v==g)if(v=0,v=0==u.c?z.abs(e[wa].x-e.end.x)/t:z.abs(e[wa].y-e.end.y)/t,20<v)y=g,w=z[Ca](180*z.atan2(e.end.y-e[wa].y,e.end.x-e[wa].x)/
z.PI),M=(0==u.c?90<=w||-90>=w?Ri:wj:0>=w&&-180<=w?Uj:ji)!=C,H=v/P;else{C=u=sc(d.aa,k);for(v=P=0;v<d.ea[D];v++){var r=d.ea[v];if(2==r.p){for(var G=r.s.a,E=k,Na=0;Na<G[D];Na++){var x=G[Na];if(7==x.p&&x.b!=j&&x.b==c){E=g;break}}E==g&&(r=r.t,G=z.abs(r-u),G<C&&(C=G,P=r))}}w-u<C&&(P=w,C=w-u);0!=C&&(y=g,M=P<u,H=z.abs(P-u)/0.2)}y==g?(Qc(d,H),Kc(c,M,k,k)):qc(d,k)}}}Td(b,a)}else a[N].ba==Gj?(c=a.Ea===a[N][va],e=He(e[Bb],e.end),t&&(p&&c)&&e>a[N].Pa?(b={type:pf+a[N][va][Ka](0).toUpperCase()+a[N][va][Da](1)+he},
a.eb(b)):a.ja(b)):a[N].ba==Kj?1500>d&&a.eb(b):a.ja(b);Ge(a)}};za(a.ga?Oj:cj,a.bb,b,k);b.setCapture&&b.setCapture();a.Ra=Pa();a.Za=a.Ra;Ud=Sd=a.Sa=k}}}function Ge(a){if(a.Xa!=g){a.Xa=g;Ia={};var b=a.ga?a.jb:q;b.releaseCapture&&b.releaseCapture();Xc(a.ga?Pj:$i,a.cb,b);Xc(a.ga?Oj:cj,a.bb,b);a.ga?Xc(Nj,a.ja,b):Xc(aj,a.ja,b);a[N].ba==ki&&(Ud=k);a.Sa==g&&Rd--}}function Td(a,b){b[N].wb==g&&(a.hypeGesturePhase=b.xa,a.hypeGestureXPosition=b.Ca[0].end.x,a.hypeGestureYPosition=b.Ca[0].end.y,b.eb(a))}function Xc(a,
b,c){c[mb]?c[mb](a,b,k):c[Db]&&c[Db](jj+a,b)}function za(a,b,c,d){var e={eventType:a,handler:b,element:c};d&&Vd[A](e);c[Ua]?c[Ua](a,b,k):c[bb]&&c[bb](jj+a,b)}function Od(a){var b={};if(a.pageX||a.pageY)b.x=a.pageX,b.y=a.pageY;else if(a[ib]||a[jb])b.x=a[ib]+q[yb].scrollLeft+q.documentElement.scrollLeft,b.y=a[jb]+q[yb].scrollTop+q.documentElement.scrollTop;return b}function Bg(a){var b;0==a.c?0==a.A?b=wj:1==a.A&&(b=Ri):1==a.c&&(0==a.A?b=Uj:1==a.A&&(b=ji));return b}function zg(a,b){var c=a[N][va]==wj||
a[N][va]==Ri?b.x:b.y;a.Fa=a.Fa==aa?c:a[N][va]==wj||a[N][va]==ji?z.max(a.Fa,c):z.min(a.Fa,c)}function Ag(a,b,c){a=z[Ca](180*z.atan2(b.y-a.y,b.x-a.x)/z.PI);c=z.min(45,45*c/2E3);if(a>=135+c||a<=-135-c)return Ri;if(a<=45-c&&a>=-45+c)return wj;if(a<-45-c&&a>-135+c)return Uj;if(a>45+c&&a<135-c)return ji}function oe(a){for(var b=tc[a],c={},d=0;d<b[D];d++){var e=U[b[d]].t;y.hb!=j&&e==jh||(c[e]=Wd(b[d]))}b=-1!=jc[Ma](ak)&&y.va!=j&&537<=ha(y.na);b=("undefined"!==typeof AudioContext||"undefined"!==typeof webkitAudioContext)&&
-1==n[vb].href[Ma](vi)&&-1==jc[Ma](Ji)&&b==k&&ea.onLine!=k&&y[Sa]==j?ik:jk;d={};d.ab=y.va!=j;var f=Ie[a];f==j&&(f=new b(a,c),f.Hb=a,f.Wa=c,f.options=d,f.rb=function(){var a=[],b;for(b in f.Wa)f.Wa[J](b)!=k&&a[A](b);return a.sort()});return f}function Cg(a){a=tc[a];if(a!=j){for(var b=1<n.devicePixelRatio,c=k,d=j,e=0;e<a[D];e++){var f=a[e],h=U[f].t;if(h==ee)d=f,c=g;else if(h==fe){if(c==k||b==g)d=f;if(b==g)break}else c==k&&(d=f)}return d}}function Je(a){a=eb(Nb,a);-1!=a&&Nb[Sb](a,1);0>=Nb[D]&&Dg()}function kk(a){var b=
U[a].p;if(1==b)if(b=U[a].g,b!=j&&Cg(b)!=a)Je(a);else{var c=new Image,b=function(b){c=this;if((y.Qa!=j||y.pb!=j&&y.va==j)&&b[ab]==Ti&&-1!=jc[Ma](li)&&-1==c.src[Ma](ld))try{var d=q[Ta](ci);ia(d,c[Ba]);ta(d,c[Rb]);d.getContext(td).drawImage(c,0,0);Eg[c.Eb]=d.toDataURL()}catch(h){}Je(a)},d=Wd(a);c.onload=b;c.onerror=b;c.onabort=b;c.src=d;c.Eb=a}else 2==b&&(b=function(){for(var b=tc[U[a].g],c=0;c<b[D];c++){var d=b[c];U[d].p!=j&&Je(d)}},d=oe(U[a].g),y.va!=j&&536.26>ha(y.na)||9>y.oa?n[lb](b,1):d.load(b,
b))}function Dg(){wd!=j&&wd(k,G);if(Tc({type:mf},G)!==k)if(-1==ne)Hb(Ob);else{Yc=g;for(var a=-1,b=0;b<Wa[D];b++){for(var c=Wa[b].X,d=0;d<c[D];d++)if(c[d]==ne){a=b;break}if(-1!=a)break}-1==a&&(a=0);Ob=a;Ke(ne)}}function Wd(a){a=U[a];var b=a.n;return b==j?j:a.r==g?V+b:V+jc+md+b}function Hd(a){for(var b=0;b<t[D];b++)if(t[b].o==a)return b;return-1}function Fg(a){a=t[a];return a==j?j:a.o}function Id(){var a=t[E];return a==j?j:a.o}function ya(){return sa(Id())}function Ld(a){return a.getElementsByClassName(Ue)}
function fb(a,b,c,d,e,f,h,l){return{i:a,t:b,d:c,f:d,o:e,s:f,e:h,r:l,p:0}}function Le(a,b,c,d,e){b={i:a,n:a,f:30,d:b,a:c,b:[]};G[B](eh,g);G[B](gh,g);t[E].T[a]=b;Jd(a,c,b);Gd=a;Sc=function(){sg(d,e,a)};qb(a,j,k)}function Zc(a,b,c,d){var e=G[Qb][Ja],f=a[Cb](bf),h=b[Cb](bf);if(K[O[a.id]]){var l=uc(f),m=vc(f);Q(a,Ph,l,gi,m)}f=uc(h);h=vc(h);Q(b,Ph,f,gi,h);c&&(c=l,f>c&&(c=f),ia(G[L],x(c)),Ib[G.id]=j,G[L].margin==kh&&(l<f?e<c?Q(a,W,z.max(0,(e-l)/2)):Q(a,W,z.max(0,(c-l)/2)):e<c?Q(b,W,z.max(0,(e-f)/2)):Q(b,
W,z.max(0,(c-f)/2))));d&&(a=m,h>a&&(a=h),ta(G[L],x(a)))}function vc(a){var b=G[Qb].offsetHeight,c=t[a].b;return c!=j?c/100*b:t[a].Z}function uc(a){var b=G[Qb][Ja],c=t[a].a;return c!=j?c/100*b:t[a].Y}function Ke(a,b,c,d){if(!(Fg(a)==j||Kd==g)){c==j&&(c=1.1);c=Be(c,60);Kd=g;var e=function(){d!=j&&d();Qa=[];Qd={};var e=ya();mc=t[a].a!=j||t[a].b!=j?g:k;var f=Fg(a),h=E,l=ya();if(l!=j){for(var m=l[hb](Yj),r=0;r<m[D];r++)m[r][xb]&&m[r][xb]();l=l[hb](oi);for(r=0;r<l[D];r++)0==l[r].id[Ma](pi)&&ja(l[r][$a],
V)}r=Fa[Da](0);for(l=0;l<r[D];l++)r[l].nb==aa&&rc(r[l]);var l=[],p;for(p in tb)if(tb[J](p)!=k){var r=k,u;for(u in pb)if(pb[J](u)!=k){for(m=0;m<pb[u][D];m++)if(p==pb[u][m]){r=g;break}if(r==g)break}r==k&&l[A](p)}for(r=0;r<l[D];r++)delete tb[l[r]];Wc=[];E=Hd(f);var m=[],h=t[h].v,s;for(s in h)if(h[J](s)!=k){var w=h[s];(l=w.cL)&&m[A](l)}h=sa(f);p=h[Cb](bf);var x=t[E].v;u=[];var F=[],$=0;for(s in x)if(x[J](s)!=k&&(w=x[s],l=w.cL)){for(var Y=k,r=0;r<m[D];r++)if(m[r]===s){Y=g;break}var S=R[l][Fb],r=S;r[Qb][kb]==
Ze&&(r=S[Qb]);if(Y){if(K[O[S.id]]){for(var w=S,ca=Y=0;w&&w.id!=H;)Y+=v(w,W,0),ca+=v(w,lh,0),w=w[Qb];Q(S,W,Y,lh,ca)}G[ua](r);R[l].xb?la(r[L],r[L][gb]+100):(F[A](r),r[L][gb]>$&&($=r[L][gb]))}else u[A]({container:r,domElement:S,sceneElement:w});R[l].mb==k&&(ug(r,g),R[l].mb=g)}for(r=0;r<F[D];r++)S=F[r],la(S[L],S[L][gb]-$-1);K[f]={};if(y.va!=j&&(f=ya(),f!=j)){f=f[hb](Yj);for(s=0;s<f[D];s++)r=f[s],ja(r,V),l=r.outerHTML,m=r[Qb],m[zb](r),ja(m,m.innerHTML+l)}if(Jc!=j){for(r=0;r<yd[D];r++)yd[r].destroy();yd=
[]}ug(h,k);for(r=0;r<u[D];r++)h[ua](u[r].container),S=u[r].domElement,w=u[r].sceneElement,Ee(w,S,S.id,g);var f=t[p].T,I;for(I in f)f[J](I)!=k&&(s=t[E].T[I],l=s.s,l==aa&&Jd(I,s.a,s));I={C:Ni,D:Pi,E:Oi};for(var Z in I)I[J](Z)==k||t[p][Z]==j||(f=X(ya(),t[p][Z].a),s=I[Z],wc[s]=f,q[Ua]?q[Ua](s,f,k):q[bb]&&q[bb](jj+s,f));Z=t[p].L;for(r=0;r<Z[D];r++)I=Z[r].B,f=X(ya(),Z[r].a),wg(I,f,j);Z={G:Ri,H:wj,I:Uj,J:ji};for(var T in Z)if(Z[J](T)!=k&&(I=t[p][T])){I=I.a;f=g;for(r=0;r<I[D];r++)if(0!=I[r].p){f=k;break}f==
k&&(I=X(ya(),I),Mb(h,{Da:1,direction:Z[T],Pa:30,ba:Gj},I))}(T=t[p].K)&&yg(q,T);T=ya();if(2==b){Zc(e,T,g,g);var fa=c,U=[];la(T[L],1);U[A](fb(mi,0,fa,lh,O[T.id],0,1));if(e!=j)if(la(e[L],0),Qf==k){var ma=O[e.id];U[A](fb(mi,0,fa,lh,ma,1,0))}else if(e[L][Ba]!=T[L][Ba]||e[L][Rb]!=T[L][Rb])ma=O[e.id],U[A](fb(mi,fa/2,fa/2,lh,ma,1,0));Q(T,mi,0);Le(ef,fa,U,e,T);qa(T[L],Hh)}else 3==b&&(y.na!=j||10<=y.Ka||10<=y.oa)?(Zc(e,T,g,g),Z=c,I=fb,h=Q,p=G[L],p[gd]=ud,pa(p,ud),p.perspective=ud,p[da.la+Sj]=oj,p.MozTransformStyle=
oj,p[Sj]=oj,f=G[Ja],p=f/4,f/=2,s=-1*p,u=-1*f,r=Z/2,m=T[Cb](bf),l=uc(m),m=vc(m),x=[],e!=j&&(fa=O[e.id],Xa(e,hf,qd),ma=e[Cb](bf),U=uc(ma),ma=vc(ma),h(e,bk,1,zh,0,Ph,U,gi,ma),x[A](I(W,0,r,gi,fa,0,f)),x[A](I(zh,0,r,gi,fa,0,-300)),x[A](I($g,0,r,gi,fa,0,-20)),x[A](I(bk,0,r,W,fa,1,0))),F=O[T.id],Xa(T,hf,qd),x[A](I(W,0,r,gi,F,s,u)),x[A](I(zh,0,r,gi,F,-600,-300)),x[A](I($g,0,r,gi,F,50,40)),x[A](I(bk,0,r,W,F,0,1)),e!=j&&(x[A](I(W,r,r,mi,fa,f,p)),x[A](I(zh,r,r,mi,fa,-300,-600)),x[A](I($g,r,r,mi,fa,-20,-50)),
(U!=l||ma!=m)&&x[A](I(mi,r,r,gi,fa,1,0))),x[A](I(W,r,r,mi,F,u,0)),x[A](I(zh,r,r,mi,F,-300,0)),x[A](I($g,r,r,mi,F,40,0)),h(T,W,p,zh,-600,$g,50,bk,0,Ph,l,gi,m),Le(gf,Z,x,e,T),qa(T[L],Hh)):4==b||5==b||6==b||7==b?(fa=c,U=[],I=e[Cb](bf),h=T[Cb](bf),ma=uc(I),Z=uc(h),I=vc(I),h=vc(h),5==b||4==b?(Zc(e,T,k,g),ma!=Z&&(U[A](fb(Ph,0,fa,Ph,H,ma,Z)),K[H]={},K[H].c=ma,K[H].d=I>h?I:h,K[H].a=0,K[H].b=0)):(Zc(e,T,g,k),I!=h&&(U[A](fb(gi,0,fa,Ph,H,I,h)),K[H]={},K[H].c=ma>Z?ma:Z,K[H].d=I,K[H].a=0,K[H].b=0)),p=W,f=Z,s=
-1*Z,5==b?(f=-1*ma,s=ma):6==b?(p=lh,f=-1*I,s=I):7==b&&(p=lh,f=h,s=-1*h),e!=j&&(u=O[e.id],Q(e,Ph,ma,gi,I),U[A](fb(p,0,fa,Ph,u,0,f))),U[A](fb(p,0,fa,Ph,O[T.id],s,0)),Q(T,Ph,Z,gi,h,p,s),Le(ff,fa,U,e,T),qa(T[L],Hh)):(Zc(e,T,k,k),sg(e,T,j));Pb()},f=k,h=ya();h[B](gh,g);if(Gg==g&&h!=j){var h=Hd(Id()),l={type:of};if(Tc(l,j)!==k){var m=t[h].B;if(m!=j){for(var s=m.a,p=X(ya(),s),m=0;m<s[D];m++){var u=s[m],x=u.b;3==u.p&&(x!=j&&t[h].T[x]!=j)&&(f=g,Gd=x,Sc=e)}p(l)}}l=Ld(ya());for(m=0;m<l[D];m++)s=l[m],t[h].v[O[s.id]].cL||
(p=v(s,Qh))&&X(s,p.a)({type:rf});for(var w in wc)wc[J](w)!=k&&(q[mb]?q[mb](w,wc[w],k):q[Db]&&q[Db](jj+w,wc[w]));wc={};for(m=0;m<Vd[D];m++)w=Vd[m],Xc(w.eventType,w.handler,w[Fb]);Vd=[]}Gg=g;f==k&&e()}}function Hb(a,b,c){Yc=k;var d=Wa[a];d==j||Kd==g||Ke(Hg(d),b,c,function(){Ob=a})}function Tf(a,b){Hb(Ob-1,a,b)}function Sf(a,b){Hb(Ob+1,a,b)}function Ig(){for(var a=[],b=0;b<Wa[D];b++)a[A](Wa[b].n);return a}function Xa(a,b,c){a=a.id;a=O[a]||a;var d=K[a];d==j&&(d={},K[a]=d);d[b]=c}function v(a,b,c){c="undefined"!=
typeof c?c:j;a=a.id;a=K[O[a]||a];if(a==j)return c;b=a[b];return b==j?c:b}function Tc(a,b){var c=n.HYPE_eventListeners;if(c!=j){for(var d=0;d<c[D];d++)if(c[d][ab]==a[ab]&&c[d].callback!=j&&c[d].callback(da.API,b,a)===k)return k;return g}}function Jg(a){var b=q[hb](zi)[0];b||(b=q[Ta](ii),q[yb][ua](b));b[ua](a)}function Kg(a){a=a[Ea](/\|/g,Hc)[Ea](/\`/g,yi)[Ea](/\@/g,Xj)[Ea](/\?/g,Ki)[Ea](/\$/g,Xi)[Ea](/\^/g,kd);xd==k&&(a=a[Ea](/rotateY\(0\)/g,hj));var b=q[Ta](ii),c=q.xmlEncoding==j?zc:V;ja(b,c+be+a+
Zd+c);Jg(b)}function $c(a,b){var c=b.f,d=z.floor(a);return Be(d+100*(a-d)/c,c)}function ye(a,b){for(var c=0,d=0;d<a[D];d++){for(var e=a[d],f=0,h=e.ta,l=0;100>l;l++){var m=jg(e,l/99),s={};s.location=m;b&&(h=He(m,h),f+=h,na(s,h));e.ca[A](s);h=m}c+=f;na(e,f)}return c}function jg(a,b){var c=xc(a.ta,a.Ga,b),d=xc(a.Ga,a.Ba,b),e=xc(a.Ba,a.Ja,b),f=xc(c,d,b),d=xc(d,e,b),f=xc(f,d,b),h=k,l=d;d.x==f.x&&d.y==f.y&&(c.x==f.x&&c.y==f.y?l=e:(l=c,h=g));f.za=ig(f,l);h==g&&(f.za+=180);return f}function ig(a,b){var c=
...
k){Ib={};var b=[],c=t[E].v,d;for(d in c)c[J](d)!=k&&c[d].bF==a&&b[A](d);for(a=0;a<b[D];a++)c=b[a],d=sa(c),oc(d),ue(c)}}function Pb(){if(!(0<Nb[D])){if(Yc==k&&Me==k){Me=g;var a=Hg(Wa[Ob]);E!=a&&Ke(a,1,0);Me=k}mc==g&&ue(j)}}function Hg(a){var b=a.X[0];if(1!=a.X[D]){var c=G[$a][Ja];if(0!=c)for(var d=0;d<a.X[D];d++){var e=a.X[d];if(t[e].d>c)break;b=e}}return b}function ag(a){var b=Lb[Id()];a!=j&&(b=Lb[a]);a=Ib[b];a==j&&(a=q[Ha](b),a={width:a[Ja],height:a.offsetHeight},Ib[b]=a);return a}function $f(a){var b=
0,c=0;a==j?(b=t[E].Y,c=t[E].Z):(b=Oc(a),c=Pc(a));return{width:b,height:c}}function se(a){return(y.na!=j||3.5<=y.Ka||10<=y.oa)&&v(a,hf)==qd}function kg(){Dd=k;we=g;for(var a in Nc)Nc[J](a)&&oc(Nc[a]);we=k;bg();Nc={}}function bg(){Jc==j||Ne==g||(Ne=g,n[lb](function(){Ne=k;Jc.refreshAll()},0))}function Oe(a,b,c){var d=b;if(d==j||q[Ha](d)!=j){do d=c+Mg();while(q[Ha](d)!=j)}Lb[a]=d;O[d]=a;return Pe[b!=j?b:d]=d}function sa(a){return q[Ha](Lb[a])}function Pa(){return Date.now()}function Mg(){for(var a=V,
...
width:{HYP_r:Ph},height:{HYP_r:gi},rotateZ:{HYP_r:ui,HYP_s:0},scaleX:{HYP_r:Wh,HYP_s:1},scaleY:{HYP_r:Xh,HYP_s:1},"z-index":{HYP_r:bk},opacity:{HYP_r:mi,HYP_s:1}},Ob=0,E=0,Qa=[],Fa=[],Oa={},Ia={},pc={},tb={},R={},Fd=k,tc={},Nb=[],K={},Ce={},Wc=[],wc={},Sc=j,Gd=j,Lb={},O={},Pe={},Eg={},Og=0,Kd=k,Vd=[],xe={},eg={},Gg=k,mc=k,Dd=k,we=k,Nc={},Ib={},Qd={},Qe={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Yc=k,Me=k,Jc=n.HYPE_w_550,yd=[],Ne=k;da.Ya=pd;da.la=fd;var Ud=k,Rd=
0,Sd=k,Vc=[];da.z_o=function(){0==Og&&(Og=Mg());wd!=j&&wd(g,G);xd=xd&&y.na!=j;Lb[H]=H;O[H]=H;Pe[H]=H;ia(G[L],x(t[0].Y));ta(G[L],x(t[0].Z));for(var a=0;a<t[D];a++){var b=t[a].T,c;for(c in b)if(b[J](c)!=k){var d=b[c];d.d=$c(d.z,d);for(var e=0;e<d.a[D];e++){var f=d.a[e];f.t=$c(f.y,d);f.d=$c(f.z,d);f.p==j?f.p=0:2==f.p&&(f.d=0);f.r==j&&(f.r=k);f.k=e}e=d.b;for(f=0;f<e[D];f++){var h=e[f];h.startTime=$c(h.C,d);h.duration=$c(h.D,d)}}}Kg(jd);fk==g&&Kg(Kf);for(a=0;a<Of[D];a++)b=Of[a],c=q[Ta](ii),ja(c,b),Jg(c);
n[lb](Pb,120);n[lb](Pb,1200);a=q[Ta](ii);a.id=$e;qa(a[L],hj);a[B](gh,g);G[ua](a);for(b=0;b<t[D];b++){c=t[b];d=q[Ta](ii);e=d[L];oa(d,af);d.id=Oe(c.o,j,Fi);d[B](bf,c.x);Qf!=k&&(e.backgroundColor=c.c);qa(e,hj);d[B](gh,g);e.overflow=Ai;e.position=ch;ia(e,x(c.Y));ta(e,x(c.Z));10<=y.oa&&(e.perspective=c.p);G[ua](d);var e=c.v,l;for(l in e)if(e[J](l)!=k&&(f=e[l],(h=f.cL)&&R[h]==j)){var m=c.T,s=[],p;for(p in m)if(m[J](p)!=k){var u=c.T[p],v=u.a;u.s==h&&(u=Jd(p,v,u,h),s[A](u))}m=q[Ta](f.k);oa(m,f.cP?Ye+f.cP:
We);m.id=Oe(l,f.i,Ei);m[L].pointerEvents=kh;m[L][mj]=kh;f.w!=j&&ja(m,f.w);if(y.na!=j||10<=y.Ka)u=Lg(m,f,c.p),a[ua](u);else a[ua](m);R[h]={element:m,sb:s,xb:f.cS,mb:k,ib:[]}}s=c.O;for(v=0;v<s[D];v++)if(l=s[v],e[J](l)!=k&&(f=e[l],h=f.cL,!(f.cM==g||h))){m=q[Ta](f.k);oa(m,f.cP?Ve+f.cP:Ue);m.id=Oe(l,f.i,Ei);m[L].pointerEvents=kh;m[L][mj]=kh;f.w!=j&&ja(m,f.w);var h=j,w;for(w in pb)if(pb[J](w)!=k){for(u=0;u<pb[w][D];u++)if(l==pb[w][u]){h=w;break}if(h!=j)break}y.na!=j||10<=y.Ka?(u=Lg(m,f,c.p),h?R[h][Fb][ua](u):
d[ua](u)):h?R[h][Fb][ua](m):d[ua](m)}}for(l=0;l<t[D];l++){p=t[l].T;for(var C in p)if(p[J](C)!=k){w=p[C].j;for(var E in w)if(w[J](E)!=k){a=w[E];b={};c=[];for(d=0;d<a[D];d++)e=a[d],c[A]({ta:{x:e[0],y:e[1]},Ga:{x:e[2],y:e[3]},Ba:{x:e[4],y:e[5]},Ja:{x:e[6],y:e[7]},length:0,ca:[]});b.ka=c;na(b,ye(c,g));xe[E]=b}}}for(var F in Qe)Qe[J](F)!=k&&(vd[F]=Qe[F]);for(var M in vd)if(vd[J](M)!=k){C=vd[M];E=[];for(F=0;F<C[D];F++)l=C[F],E[A]({ta:{x:l[0],y:l[1]},Ga:{x:l[2],y:l[3]},Ba:{x:l[4],y:l[5]},Ja:{x:l[6],y:l[7]},
length:0,ca:[]});ye(E,k);eg[M]=E}for(var K in U)U[J](K)!=k&&(M=U[K].g,M!=j&&(C=tc[M],C==j&&(C=[],tc[M]=C),C[A](K)));for(var r in U)U[J](r)!=k&&U[r].p!=j&&-1==eb(Nb,r)&&Nb[A](r);K=Nb[Da](0);if(0==K[D])Dg();else for(r=0;r<K[D];r++)kk(K[r]);n[Ua]?(n[Ua](sj,function(){Yc=k;Pb()}),n[Ua](lj,function(){n[lb](Pb,1)})):n[bb]&&n[bb](kj,function(){Yc=k;Pb()});Ic&&(G[L][hd]=vj,G[Ua]&&(G[Ua](di,Pd,g),G[Ua](cj,Pd,g),G[Ua](Zi,Pd,g),G[Ua](bj,Pd,g)))};var y;var Ra=function(a){return(a=ea&&ea[ob]&&ea[ob].match(a))&&
...
b},yy:function(a,b){a[L].whiteSpace=b},y:function(a,b){a[L].whiteSpaceCollapsing=b},z:function(a,b){la(a[L],b);a[Qb][kb]==Ze&&la(a[Qb][L],b)},aA:function(a,b){var c=X(a,b.a);Ic&&(Mb(a,{Da:1,ba:Kj},c),a[L][hd]=vj);a[B](xj,Oh);Aa(di,a,c,g)},aD:function(a,b){Aa(bj,a,X(a,b.a),k)},aC:function(a,b){Aa(aj,a,X(a,b.a),k)},aE:function(a,b){var c=X(a,b.a);Ic&&(Aa(Oj,a,c,g),a[L][hd]=vj);a[B](xj,Oh);Aa(cj,a,c,g)},aB:function(a,b){var c=X(a,b.a);if(Ic){var d=k;if(y.va!=j)for(var e=b.a,f=0;f<e[D];f++)if(5==e[f].p&&
e[f].k==g){d=g;break}d!=g&&Aa(Qj,a,c,g);a[L][hd]=vj}a[B](xj,Oh);Aa(Zi,a,c,g)},bN:function(a,b){yg(a,b)},cW:function(a,b){Rf(a,X(a,b.a),ri)},cX:function(a,b){Rf(a,X(a,b.a),ti)},cG:function(a,b){Mb(a,{Da:1,direction:wj,Pa:30,ba:Gj},X(a,b.a))},cH:function(a,b){Mb(a,{Da:1,direction:Ri,Pa:30,ba:Gj},X(a,b.a))},cI:function(a,b){Mb(a,{Da:1,direction:Uj,Pa:30,ba:Gj},X(a,b.a))},cJ:function(a,b){Mb(a,{Da:1,direction:ji,Pa:30,ba:Gj},X(a,b.a))},cK:Lc,cF:Lc,aM:function(a,b){Aa(bj,a,qe(a,b),k);Aa(aj,a,zd(a,b),k)},
...
a,g);za(Zi,c,a,g);za(di,c,a,g)}}},Ie={},yc=j;da.API={kSceneTransitionInstant:1,kSceneTransitionCrossfade:2,kSceneTransitionSwap:3,kSceneTransitionPushLeftToRight:4,kSceneTransitionPushRightToLeft:5,kSceneTransitionPushBottomToTop:6,kSceneTransitionPushTopToBottom:7,kHypeGesturePhaseStart:Dj,kHypeGesturePhaseMove:dj,kHypeGesturePhaseEnd:qi,kHypeGesturePhaseCancel:ai,documentName:function(){return $},documentId:function(){return H},sceneNames:Ig,currentSceneName:function(){return Wa[Ob].n},showSceneNamed:function(a,
b,c){a=eb(Ig(),a);Hb(a,b,c)},showNextScene:Sf,showPreviousScene:Tf,playTimelineNamed:rg,startTimelineNamed:rg,goToTimeInTimelineNamed:function(a,b){var c=ub(b);c==j&&(c=Mi);sb(a,c,k,k)},pauseTimelineNamed:function(a){a=ub(a);a==j&&(a=Mi);rb(a,j)},continueTimelineNamed:function(a,b,c){a=ub(a);a==j&&(a=Mi);b==aa&&(b=0);Kc(a,1==b?g:k,g,c)},getElementById:function(a){var b=Pe[a];b==j&&(b=a);return q[Ha](b)},setElementProperty:function(a,b,c,d,e){var f={easein:gi,easeout:mi,easeinout:Ph,linear:lh};b=Ng[b];
if(b!=j){var h=b.HYP_r,l=O[a.id];b=V+l+h;0<d&&h!=bk?(a=j,e!=j&&(a=f[e]),a==j&&(a=Ph),c=[fb(h,0,d,a,l,1,c,g)],d={i:b,n:b,f:30,d:d,a:c,b:[]},t[E].T[b]=d,Jd(b,c,d),qb(b,j,k)):(Oa[l]!=aa&&(Oa[l][h]=b),d=ca(b),d!=j&&rc(d),Q(a,h,c))}},getElementProperty:function(a,b){var c=Ng[b];if(c==j)return j;var d=K[O[a.id]][c.HYP_r];return d!=j?d:c.HYP_s},functions:function(){return Pf},resourcesFolderURL:function(){return jc},relayoutIfNecessary:Pb,kDirectionForward:0,kDirectionReverse:1,currentTimeInTimelineNamed:function(a){a=
...
n.HYPE==j&&(n.HYPE=n.HYPE_550,n.HYPE.documents={});var ck=[];n.HYPE_dtl_550!=j&&(ck=n.HYPE_dtl_550[Da](0));n.HYPE_dtl_550=[];for(var dk=0;dk<ck[D];dk++)ck[dk]();})();
