...
q.HYPE_510=function(L,B,ha,ic,Of,Pf,Wa,v,pb,dk,wd,xd,kk,Qf,ne,yd,ek,fk,Jc){function Rf(a,b,c){jc!=k&&(a={element:a,triggerOnce:p,elementOffset:0},a[c]=function(){b()},new jc.hypeS(a))}function X(a,b){return function(c){for(var d=0;d<b[J];d++){var e=b[d],f=e.p;if(1==f){var h=e.f,f=e.g,m=e.d;if(h==k||0==h){a:{for(h=0;h<Wa[J];h++)if(Wa[h].o==e.e){e=h;break a}e=-1}Gb(e,f,m)}else 1==h?Sf(f,m):2==h?Tf(f,m):3==h?Gb(0,f,m):4==h&&Gb(Wa[J]-1,f,m)}else if(3==f)e.b!=k&&(f=e.z!=g?e.z:p,qb(e.b,a!=k?a.id:k,f));
else if(7==f)e.b!=k&&rb(e.b,e.r);else if(8==f)e.b!=k&&(f=e.z!=g?e.z:p,Kc(e.b,f,j,e.J!=g?e.J:p));else if(9==f)e.b!=k&&e.i!=k&&kc(e.i,e.b,p);else if(4==f){if(e.h!=k){e=dk[e.h];try{Pf[e](ca.API,a,c)}catch(n){q[Fb]&&q[Fb].log(Te+e+Yd+n)}}}else if(5==f)f=Uf(e.j),f!=k&&((e=(e=e.k==j)||1==c.button||c.metaKey==j)?9>w.oa||w.Db||w.Ka!=k?q.open(f,Nf):(9==w.oa||15>w[Sa])&&!(c instanceof MouseEvent)?q.open(f,Nf):(e=y[Ta]($),e[D](Ai,f),e[D](Kj,Nf),y[zb][ua](e),f=y.createEvent(zf),f.initMouseEvent(ci,c.bubbles,
...
db=P[a.id];db!=k&&Q[db]!=k;)if(db=Q[db].bF,db!=k&&Q[db]!=k&&(Q[db].cQ!=k||Q[db].cR!=k||mc==j&&0!=(Q[db].bS&256))){ba=j;break}Xa(a,lf,ba)}d!=k&&(c+=ec+A(d,2)+Gc);e!=k&&(c+=fc+A(e,2)+Gc);0!=f&&(c+=gc+A(f)+Gc);0!=s&&t(a,xh)==Lf&&(c+=Zb+(W+s+gi)+Gc);0!=n&&(c+=Zb+(W+n+gi)+Gc);10>w.oa||(0!=m?c+=ac+(W+m+gi)+Gc:b==j&&(1==l&&1==r&&ba==p)&&(c+=bc),0!=h&&(c+=$b+(W+h+gi)+Gc));1!=l&&(c+=cc+l+Gc);1!=r&&(c+=dc+r+Gc);b=W+(W+100*u+yc)+Wb+(W+100*N+yc);a[O][ca.ma+Qj]=b;a[O].MozTransformOrigin=b;a[O].OTransformOrigin=
b;a[O][fd]=b;a[O][Qj]=b;a[O][kd]=c;a[O].MozTransform=c;a[O].OTransform=c;a[O][ed]=c;a[O].transform=c}function nc(a){Mc(a)}function te(a){function b(a,b){return W+a+Ri+(W+(b==j?(z.abs(e)+180)%360:(360-z.abs(e)+270)%360)+gi)+Hc+c+Hc+d+Fc}var c=t(a,ej);if(!(c==k||c==W)){var d=t(a,Ui);if(!(d==k||d==W)){var e=t(a,Pi);e!=k&&(a[O].backgroundImage=w.ka!=k?b(ca.ma,p):w.yb!=k?b(cd,p):15>w[Sa]?b(gd,p):b(W,j))}}}function Yf(a){ra(a[O],t(a,Zh,p)==j?gj:t(a,qj,W));ue(P[a.id])}function Ya(a){Ib[a.id]=k;oc(a)}function oc(a){try{if(Cd==
j)Nc[a.id]=a;else{var b=t(a,Ah,36),c=se(a),d=P[a.id],e=ve(d),f=Zf(e),h=$f(e),m=Zf(d),n=t(a,$,0),s=t(a,kh,0),l=t(a,Oh,k),r=t(a,fi,k),ba=e=j;l==k&&(e=p,l=m[Ba]);r==k&&(ba=p,r=m[Sb]);var u=Oc(d),N=Pc(d),d=N-r,m=n,Q=s,v=u,M=N,w=p;if(mc==j&&36!=b){var ia=0!=(b&1),Jb=0!=(b&4),B=0!=(b&2),Na=0!=(b&8),F=0!=(b&32),E=0!=(b&16),H=0!=(b&64)&&B==j&&E==j,x=0!=(b&128)&&B==j&&E==j,w=0!=(b&256)&&(B==j||E==j),I=h[Ba]/f[Ba],R=h[Sb]/f[Sb];B==j&&(v=ia==j&&Jb==j?u+(h[Ba]-f[Ba]):z[Ga](u*I));ia==j&&Jb==j&&B==p?(b=n+u/2,m=
z[Ga](b*I-u/2)):ia==j&&Jb==p&&B==j?m=h[Ba]-f[Ba]+n-(v-u):ia==j&&Jb==p?m=h[Ba]-f[Ba]+n:ia==p&&Jb==p&&(m=z[Ga](n*I));E==j&&(M=Na==j&&F==j?N+(h[Sb]-f[Sb]):z[Ga](N*R));Na==j&&F==j&&E==p?Q=z[Ga]((s+N/2)*R-N/2):Na==j&&F==p&&E==j?Q=h[Sb]-f[Sb]+s-(M-N):Na==j&&F==p?Q=h[Sb]-f[Sb]+s:Na==p&&F==p&&(Q=z[Ga](s*R));if((H==j||x==j)==j)h=v,f=M,s=v/u,I=M/N,R=s,H==j?R=s<=I?s:I:x==j&&(R=s>=I?s:I),v=z[Ga](u*R),M=z[Ga](N*R),H=h-v,x=f-M,ia==j&&Jb==p?m+=H:ia==j&&Jb==j&&(m+=z[Ga](H/2)),Na==j&&F==p?Q+=x:Na==j&&F==j&&(Q+=z[Ga](x/
...
a)return c}for(var d in R)if(R[K](d)!=p)for(var e=R[d].sb,b=0;b<e[J];b++)if(c=e[b],c.aa==a)return c;return k}function vb(a){var b=v[E].T,c;for(c in b)if(b[K](c)!=p&&b[c].n==a){var d=p,e=v[E].U,f;for(f in e)if(e[K](f)!=p){var h=e[f].V;for(a in h)if(h[K](a)!=p&&h[a]==c){d=j;break}if(d==j)break}if(d==p)return c}return k}function Jd(a,b,c,d){b={ta:0,ia:[],ea:b,aa:a,Va:c.b,fa:p,na:0,ha:1,$:p,qa:[],nb:d,Ha:c,Sa:{}};for(c=0;c<Qa[J];c++)Qa[c].aa==a&&(Sc(Qa[c]),Qa[Tb](c,1),c-=1);Qa[C](b);return b}function qc(a,
b){var c=rc(a.aa,p);if(b!=a.$){a.$=b;b==j&&a.Na==k&&(a.Na=a.ea[Da](0),a.Na.sort(function(b,c){var d=Za(b,a),m=Za(c,a);return d==m?c.k-b.k:d-m}));b==j&&a.Ta==k&&(a.Ta=a.Va[Da](0),a.Ta.sort(function(b,c){var d=Z(b[Qb]+b[nb],a),m=Z(c[Qb]+c[nb],a);return d==m?(d=b[Qb],m=c[Qb],d==m?c.F-b.F:m-d):m-d}));var d=S(a);a.ia=[];a.ta=0;a.ya=0;a.qa=[];a.na=Z(d-a.na,a);ng(a,d-c);a.da!=k&&tb(Z(Pa()/1E3-a.da,a),a,p,p)}}function Qc(a,b){if(a.ha!=b){var c=rc(a.aa,p);a.ha=b;ng(a,c)}}function ng(a,b){a.da!=k&&(a.da=Pa()/
...
r);r=z.max(0,r);kc(r,d,p)}else a.ja(b);if(a[V].Ia!=k){c=P[a[V].Ia.id];r=ve(c);u=e=0;for(v=d=1;r!=k&&r!=B;){var N=ta(r),e=e+t(N,$,0);u+=t(N,kh,0);d*=t(N,Vh,1);v*=t(N,Wh,1);r=ve(r)}d=a.kb+(l.end.x-l[Cb].x)/d;l=a.lb+(l.end.y-l[Cb].y)/v;mc==p&&(r=$f(r),v=Oc(c),d=z.max(d,-v/2-e),d=z.min(d,r[Ba]-v/2-e),c=Pc(c),l=z.max(l,-c/2-u),l=z.min(l,r[Sb]-c/2-u));I(a[V].Ia,$,d,kh,l)}Td(b,a)}else a[V].ca==Fj?1<a.La?a.ja(b):(b[La]&&a.Ea==a[V][va]&&b[La](),u=a[V][va]==vj||a[V][va]==Qi?l.end.x:l.end.y,l=p,l=a[V][va]==
...
sc[a],c={},d=0;d<b[J];d++){var e=ha[b[d]].t;w.hb!=k&&e==ih||(c[e]=Wd(b[d]))}b=-1!=ic[Ma]($j)&&w.ra!=k&&537<=ga(w.ka);b=("undefined"!==typeof AudioContext||"undefined"!==typeof webkitAudioContext)&&-1==q[wb].href[Ma](ui)&&-1==ic[Ma](Ii)&&b==p&&da.onLine!=p&&w[Sa]==k?hk:ik;d={};d.ab=w.ra!=k;var f=Ie[a];f==k&&(f=new b(a,c),f.Hb=a,f.Ua=c,f.options=d,f.rb=function(){var a=[],b;for(b in f.Ua)f.Ua[K](b)!=p&&a[C](b);return a.sort()});return f}function zg(a){a=sc[a];if(a!=k){for(var b=1<q.devicePixelRatio,
c=p,d=k,e=0;e<a[J];e++){var f=a[e],h=ha[f].t;if(h==fe)d=f,c=j;else if(h==ge){if(c==p||b==j)d=f;if(b==j)break}else c==p&&(d=f)}return d}}function Je(a){a=sb(Mb,a);-1!=a&&Mb[Tb](a,1);0>=Mb[J]&&Ag()}function jk(a){var b=ha[a].p;if(1==b)if(b=ha[a].g,b!=k&&zg(b)!=a)Je(a);else{var c=new Image,b=function(b){c=this;if((w.Wa!=k||w.pb!=k&&w.ra==k)&&b[ab]==Si&&-1!=ic[Ma](ki)&&-1==c.src[Ma](nd))try{var d=y[Ta](bi);ja(d,c[Ba]);sa(d,c[Sb]);d.getContext(vd).drawImage(c,0,0);Bg[c.Eb]=d.toDataURL()}catch(h){}Je(a)},
d=Wd(a);c.onload=b;c.onerror=b;c.onabort=b;c.src=d;c.Eb=a}else 2==b&&(b=function(){for(var b=sc[ha[a].g],c=0;c<b[J];c++){var d=b[c];ha[d].p!=k&&Je(d)}},d=oe(ha[a].g),w.ra!=k&&536.26>ga(w.ka)||9>w.oa?q[lb](b,1):d.load(b,b))}function Ag(){xd!=k&&xd(p,F);if(Gd({type:of},F)!==p)if(-1==ne)Gb(Nb);else{Zc=j;for(var a=-1,b=0;b<Wa[J];b++){for(var c=Wa[b].X,d=0;d<c[J];d++)if(c[d]==ne){a=b;break}if(-1!=a)break}-1==a&&(a=0);Nb=a;Ke(ne)}}function Wd(a){a=ha[a];var b=a.n;return b==k?k:a.r==j?W+b:W+ic+od+b}function Hd(a){for(var b=
0;b<v[J];b++)if(v[b].o==a)return b;return-1}function Cg(a){a=v[a];return a==k?k:a.o}function Id(){var a=v[E];return a==k?k:a.o}function ya(){return ta(Id())}function Ld(a){return a.getElementsByClassName(We)}function eb(a,b,c,d,e,f,h,m){return{i:a,t:b,d:c,f:d,o:e,s:f,e:h,r:m,p:0}}function Le(a,b,c,d,e){b={i:a,n:a,f:30,d:b,a:c,b:[]};F[D](dh,j);F[D](fh,j);v[E].T[a]=b;Jd(a,c,b);Fd=a;Tc=function(){pg(d,e,a)};qb(a,k,p)}function $c(a,b,c,d){var e=F[Rb][Ja],f=a[Db](df),h=b[Db](df);if(H[P[a.id]]){var m=tc(f),
n=uc(f);I(a,Oh,m,fi,n)}f=tc(h);h=uc(h);I(b,Oh,f,fi,h);c&&(c=m,f>c&&(c=f),ja(F[O],A(c)),Ib[F.id]=k,F[O].margin==jh&&(m<f?e<c?I(a,$,z.max(0,(e-m)/2)):I(a,$,z.max(0,(c-m)/2)):e<c?I(b,$,z.max(0,(e-f)/2)):I(b,$,z.max(0,(c-f)/2))));d&&(a=n,h>a&&(a=h),sa(F[O],A(a)))}function uc(a){var b=F[Rb].offsetHeight,c=v[a].b;return c!=k?c/100*b:v[a].Z}function tc(a){var b=F[Rb][Ja],c=v[a].a;return c!=k?c/100*b:v[a].Y}function Ke(a,b,c,d){if(!(Cg(a)==k||Kd==j)){c==k&&(c=1.1);c=Ce(c,60);Kd=j;var e=function(){d!=k&&d();
Qa=[];Qd={};var e=ya();mc=v[a].a!=k||v[a].b!=k?j:p;var f=Cg(a),h=E,m=ya();if(m!=k){for(var n=m[hb](Xj),l=0;l<n[J];l++)n[l][yb]&&n[l][yb]();m=m[hb](ni);for(l=0;l<m[J];l++)0==m[l].id[Ma](oi)&&ka(m[l][$a],W)}l=Fa[Da](0);for(m=0;m<l[J];m++)l[m].nb==g&&Sc(l[m]);var m=[],r;for(r in ub)if(ub[K](r)!=p){var l=p,s;for(s in pb)if(pb[K](s)!=p){for(n=0;n<pb[s][J];n++)if(r==pb[s][n]){l=j;break}if(l==j)break}l==p&&m[C](r)}for(l=0;l<m[J];l++)delete ub[m[l]];Xc=[];E=Hd(f);var n=[],h=v[h].v,u;for(u in h)if(h[K](u)!=
p){var A=h[u];(m=A.cL)&&n[C](m)}h=ta(f);r=h[Db](df);var x=v[E].v;s=[];var L=[],Z=0;for(u in x)if(x[K](u)!=p&&(A=x[u],m=A.cL)){for(var U=p,l=0;l<n[J];l++)if(n[l]===u){U=j;break}var S=R[m][Pb],l=S;l[Rb][kb]==af&&(l=S[Rb]);if(U){if(H[P[S.id]]){for(var A=S,ha=U=0;A&&A.id!=B;)U+=t(A,$,0),ha+=t(A,kh,0),A=A[Rb];I(S,$,U,kh,ha)}F[ua](l);R[m].xb?ma(l[O],l[O][gb]+100):(L[C](l),l[O][gb]>Z&&(Z=l[O][gb]))}else s[C]({container:l,domElement:S,sceneElement:A});R[m].mb==p&&(rg(l,j),R[m].mb=j)}for(l=0;l<L[J];l++)S=
L[l],ma(S[O],S[O][gb]-Z-1);H[f]={};if(w.ra!=k&&(f=ya(),f!=k)){f=f[hb](Xj);for(u=0;u<f[J];u++)l=f[u],ka(l,W),m=l.outerHTML,n=l[Rb],n[Ab](l),ka(n,n.innerHTML+m)}jc!=k&&jc.destroyAll();rg(h,p);for(l=0;l<s[J];l++)h[ua](s[l].container),S=s[l].domElement,A=s[l].sceneElement,Ee(A,S,S.id,j);var f=v[r].T,G;for(G in f)f[K](G)!=p&&(u=v[E].T[G],m=u.s,m==g&&Jd(G,u.a,u));G={C:Mi,D:Oi,E:Ni};for(var Y in G)G[K](Y)==p||v[r][Y]==k||(f=X(ya(),v[r][Y].a),u=G[Y],vc[u]=f,y[Ua]?y[Ua](u,f,p):y[bb]&&y[bb](ij+u,f));Y=v[r].L;
for(l=0;l<Y[J];l++)G=Y[l].B,f=X(ya(),Y[l].a),tg(G,f,k);Y={G:Qi,H:vj,I:Tj,J:ii};for(var T in Y)if(Y[K](T)!=p&&(G=v[r][T])){G=G.a;f=j;for(l=0;l<G[J];l++)if(0!=G[l].p){f=p;break}f==p&&(G=X(ya(),G),Lb(h,{Da:1,direction:Y[T],Oa:30,ca:Fj},G))}(T=v[r].K)&&vg(y,T);T=ya();if(2==b){$c(e,T,j,j);var ea=c,ba=[];ma(T[O],1);ba[C](eb(li,0,ea,kh,P[T.id],0,1));if(e!=k)if(ma(e[O],0),Qf==p){var na=P[e.id];ba[C](eb(li,0,ea,kh,na,1,0))}else if(e[O][Ba]!=T[O][Ba]||e[O][Sb]!=T[O][Sb])na=P[e.id],ba[C](eb(li,ea/2,ea/2,kh,
na,1,0));I(T,li,0);Le(gf,ea,ba,e,T);ra(T[O],Gh)}else 3==b&&(w.ka!=k||10<=w.Ka||10<=w.oa)?($c(e,T,j,j),Y=c,G=eb,h=I,r=F[O],r[id]=Xd,qa(r,Xd),r.perspective=Xd,r[ca.ma+Rj]=nj,r.MozTransformStyle=nj,r[Rj]=nj,f=F[Ja],r=f/4,f/=2,u=-1*r,s=-1*f,l=Y/2,n=T[Db](df),m=tc(n),n=uc(n),x=[],e!=k&&(ea=P[e.id],Xa(e,kf,sd),na=e[Db](df),ba=tc(na),na=uc(na),h(e,ak,1,yh,0,Oh,ba,fi,na),x[C](G($,0,l,fi,ea,0,f)),x[C](G(yh,0,l,fi,ea,0,-300)),x[C](G(Zg,0,l,fi,ea,0,-20)),x[C](G(ak,0,l,$,ea,1,0))),L=P[T.id],Xa(T,kf,sd),x[C](G($,
0,l,fi,L,u,s)),x[C](G(yh,0,l,fi,L,-600,-300)),x[C](G(Zg,0,l,fi,L,50,40)),x[C](G(ak,0,l,$,L,0,1)),e!=k&&(x[C](G($,l,l,li,ea,f,r)),x[C](G(yh,l,l,li,ea,-300,-600)),x[C](G(Zg,l,l,li,ea,-20,-50)),(ba!=m||na!=n)&&x[C](G(li,l,l,fi,ea,1,0))),x[C](G($,l,l,li,L,s,0)),x[C](G(yh,l,l,li,L,-300,0)),x[C](G(Zg,l,l,li,L,40,0)),h(T,$,r,yh,-600,Zg,50,ak,0,Oh,m,fi,n),Le(jf,Y,x,e,T),ra(T[O],Gh)):4==b||5==b||6==b||7==b?(ea=c,ba=[],G=e[Db](df),h=T[Db](df),na=tc(G),Y=tc(h),G=uc(G),h=uc(h),5==b||4==b?($c(e,T,p,j),na!=Y&&
(ba[C](eb(Oh,0,ea,Oh,B,na,Y)),H[B]={},H[B].c=na,H[B].d=G>h?G:h,H[B].a=0,H[B].b=0)):($c(e,T,j,p),G!=h&&(ba[C](eb(fi,0,ea,Oh,B,G,h)),H[B]={},H[B].c=na>Y?na:Y,H[B].d=G,H[B].a=0,H[B].b=0)),r=$,f=Y,u=-1*Y,5==b?(f=-1*na,u=na):6==b?(r=kh,f=-1*G,u=G):7==b&&(r=kh,f=h,u=-1*h),e!=k&&(s=P[e.id],I(e,Oh,na,fi,G),ba[C](eb(r,0,ea,Oh,s,0,f))),ba[C](eb(r,0,ea,Oh,P[T.id],u,0)),I(T,Oh,Y,fi,h,r,u),Le(hf,ea,ba,e,T),ra(T[O],Gh)):($c(e,T,p,p),pg(e,T,k));Ob()},f=p,h=ya();h[D](fh,j);if(Dg==j&&h!=k){var h=Hd(Id()),m={type:qf};
if(Gd(m,k)!==p){var n=v[h].B;if(n!=k){for(var s=n.a,l=X(ya(),s),n=0;n<s[J];n++){var r=s[n],A=r.b;3==r.p&&(A!=k&&v[h].T[A]!=k)&&(f=j,Fd=A,Tc=e)}l(m)}}m=Ld(ya());for(n=0;n<m[J];n++)s=m[n],v[h].v[P[s.id]].cL||(l=t(s,Ph))&&X(s,l.a)({type:tf});for(var u in vc)vc[K](u)!=p&&(y[mb]?y[mb](u,vc[u],p):y[Eb]&&y[Eb](ij+u,vc[u]));vc={};for(n=0;n<Vd[J];n++)u=Vd[n],Yc(u.eventType,u.handler,u[Pb]);Vd=[]}Dg=j;f==p&&e()}}function Gb(a,b,c){Zc=p;var d=Wa[a];d==k||Kd==j||Ke(Eg(d),b,c,function(){Nb=a})}function Tf(a,b){Gb(Nb-
1,a,b)}function Sf(a,b){Gb(Nb+1,a,b)}function Fg(){for(var a=[],b=0;b<Wa[J];b++)a[C](Wa[b].n);return a}function Xa(a,b,c){a=a.id;a=P[a]||a;var d=H[a];d==k&&(d={},H[a]=d);d[b]=c}function t(a,b,c){c="undefined"!=typeof c?c:k;a=a.id;a=H[P[a]||a];if(a==k)return c;b=a[b];return b==k?c:b}function Gd(a,b){var c=q.HYPE_eventListeners;if(c!=k){for(var d=0;d<c[J];d++)if(c[d][ab]==a[ab]&&c[d].callback!=k&&c[d].callback(ca.API,b,a)===p)return p;return j}}function Gg(a){var b=y[hb](yi)[0];b||(b=y[Ta](hi),y[zb][ua](b));
b[ua](a)}function Hg(a){a=a[Ea](/\|/g,bd)[Ea](/\`/g,xi)[Ea](/\@/g,Wj)[Ea](/\?/g,Ji)[Ea](/\$/g,Wi)[Ea](/\^/g,md);yd==p&&(a=a[Ea](/rotateY\(0\)/g,gj));var b=y[Ta](hi),c=y.xmlEncoding==k?Bc:W;ka(b,c+ce+a+$d+c);Gg(b)}function ad(a,b){var c=b.f,d=z.floor(a);return Ce(d+100*(a-d)/c,c)}function ze(a,b){for(var c=0,d=0;d<a[J];d++){for(var e=a[d],f=0,h=e.ua,m=0;100>m;m++){var n=hg(e,m/99),s={};s.location=n;b&&(h=He(n,h),f+=h,oa(s,h));e.ba[C](s);h=n}c+=f;oa(e,f)}return c}function hg(a,b){var c=wc(a.ua,a.Ga,
b),d=wc(a.Ga,a.Ba,b),e=wc(a.Ba,a.Ja,b),f=wc(c,d,b),d=wc(d,e,b),f=wc(f,d,b),h=p,m=d;d.x==f.x&&d.y==f.y&&(c.x==f.x&&c.y==f.y?m=e:(m=c,h=j));f.za=gg(f,m);h==j&&(f.za+=180);return f}function gg(a,b){var c=0,c=b.x==a.x?b.y>=a.y?90:-90:180*z.atan((b.y-a.y)/(b.x-a.x))/z.PI;b.x<a.x&&(c+=180);return c}function wc(a,b,c){return{x:a.x+(b.x-a.x)*c,y:a.y+(b.y-a.y)*c,za:0}}function He(a,b){return z.sqrt((b.x-a.x)*(b.x-a.x)+(b.y-a.y)*(b.y-a.y))}function Ig(a,b,c){var d=y[Ta](hi),e=d[O];pa(d,af);e.position=bh;e.top=
pd;e.left=pd;ja(e,ud);sa(e,ud);if(b.bR!=k||b.aY!=k)e[id]=c,qa(e,c),e.perspective=c;e.pointerEvents=gj;e[lj]=gj;a[O].pointerEvents=jh;a[O][lj]=jh;d[ua](a);return d}function ve(a){a=v[E].v[a];return a==k?k:a.bF}function ue(a){if(mc!=p){Ib={};var b=[],c=v[E].v,d;for(d in c)c[K](d)!=p&&c[d].bF==a&&b[C](d);for(a=0;a<b[J];a++)c=b[a],d=ta(c),oc(d),ue(c)}}function Ob(){if(!(0<Mb[J])){if(Zc==p&&Me==p){Me=j;var a=Eg(Wa[Nb]);E!=a&&Ke(a,1,0);Me=p}mc==j&&ue(k)}}function Eg(a){var b=a.X[0];if(1!=a.X[J]){var c=
F[$a][Ja];if(0!=c)for(var d=0;d<a.X[J];d++){var e=a.X[d];if(v[e].d>c)break;b=e}}return b}function $f(a){var b=Kb[Id()];a!=k&&(b=Kb[a]);a=Ib[b];a==k&&(a=y[Ha](b),a={width:a[Ja],height:a.offsetHeight},Ib[b]=a);return a}function Zf(a){var b=0,c=0;a==k?(b=v[E].Y,c=v[E].Z):(b=Oc(a),c=Pc(a));return{width:b,height:c}}function se(a){return(w.ka!=k||3.5<=w.Ka||10<=w.oa)&&t(a,kf)==sd}function ig(){Cd=p;we=j;for(var a in Nc)Nc[K](a)&&oc(Nc[a]);we=p;xe();Nc={}}function xe(){q[lb](function(){jc!=k&&(Ne?Oe=j:(Ne=
j,jc.refreshAll(),Ne=p,Oe&&(Oe=p,xe())))},0)}function Pe(a,b,c){var d=b;if(d==k||y[Ha](d)!=k){do d=c+Jg();while(y[Ha](d)!=k)}Kb[a]=d;P[d]=a;return Qe[b!=k?b:d]=d}function ta(a){return y[Ha](Kb[a])}function Pa(){return Date.now()}function Jg(){for(var a=W,b=ca.Ya+Ve,c=0;20>c;c++)var d=z.floor(z.random()*b[J]),a=a+b.substring(d,d+1);return a}function ik(a){var b=this;Ie[a]=b;b.qb=function(){var a=y[Ta](hh);b.Aa=a;for(var d=b.rb(),e=0;e<d[J];e++){var f=d[e],h=y[Ta](Aj);h[D](Bj,b.Ua[f]);h[D](Sj,f);a[ua](h)}y[zb][ua](a);
return a};b.load=function(a,d){if(!(b.sa==j||b.wa==j)){var e=b.qb(),f=function(){q[xa](b.ub);b.sa!=j&&(b.wa=p,b.sa=j,a!=k&&a(b),b.Ma==j&&b[Va]())},h=function(){q[xa](b.ub);b.sa!=j&&(b.wa=p,d!=k&&d(b))};e[Ua](ai,f,j);e[Ua](ah,h,j);e[Ua](ri,h,j);b.ub=q[lb](h,15E3);b.wa=j;da.onLine==k||da.onLine==j?e.load():f()}};b.play=function(){if(b.sa!=j){if(b.wa==j){b.Ma=j;return}b.sa=j}b.Aa==k&&b.qb();try{la(b.Aa,b.loop),b.Aa.currentTime=0}catch(a){}b.Aa[Va]()};b.pause=function(){b.sa!=j?b.Ma=p:b.Aa!=k&&b.Aa[yb]()}}
function hk(a){var b=this;Ie[a]=b;xc==k&&("undefined"!==typeof AudioContext?xc=new AudioContext:"undefined"!==typeof webkitAudioContext&&(xc=new webkitAudioContext));b.load=function(a,d){if(!(b.sa==j||b.wa==j)){b.wa=j;var e=b.Gb();-1==e[Ma](ee)&&(e=W+e+ee);var f=new XMLHttpRequest;f.open(Ue,e,j);f.responseType=gh;f.onload=function(){xc.decodeAudioData(f.response,function(d){b.vb=d;b.wa=p;b.sa=j;a!=k&&a(b);b.Ma==j&&(b[cb]!=k&&b[V].ab==j?b[cb].buffer=d:b[Va]())},function(){b.wa=p;d!=k&&d(b)})};f.onerror=
function(){b.wa=p;d!=k&&d(b)};try{f.send()}catch(h){}}};b.play=function(){b.gb();b.source=xc.createBufferSource();b[cb].connect(xc.destination);la(b[cb],b.loop);b[V].ab==j&&b.fb();b.sa!=j?(b.Ma=j,b.load()):(b[cb].buffer=b.vb,b[V].ab!=j&&b.fb())};b.pause=function(){b.sa!=j?b.Ma=p:b.gb()};b.fb=function(){try{if(b[cb]!=k)if(b[cb].noteOn!=k)b[cb].noteOn(0);else b[cb][Cb](0)}catch(a){}};b.gb=function(){try{b[cb]!=k&&(b[cb].noteOff!=k?b[cb].noteOff(0):b[cb].stop(0))}catch(a){}};b.Gb=function(){if(b.$a!=
k)return b.$a;for(var a=y[Ta](hh),d=b.rb(),e=0;e<d[J];e++){var f=d[e];b.$a=b.Ua[f];if(a.canPlayType(f)!=fj&&a.canPlayType(f)!=W)break}return b.$a}}var ca=this,F=y[Ha](B),Md=[Xh,Yh],Vc=[Mg,Pg,Og,Qg,Ng,vh,Rg,Sg,Bh],Kg={top:{HYP_r:kh},left:{HYP_r:$},width:{HYP_r:Oh},height:{HYP_r:fi},rotateZ:{HYP_r:ti,HYP_s:0},scaleX:{HYP_r:Vh,HYP_s:1},scaleY:{HYP_r:Wh,HYP_s:1},"z-index":{HYP_r:ak},opacity:{HYP_r:li,HYP_s:1}},Nb=0,E=0,Qa=[],Fa=[],Oa={},Ia={},pc={},ub={},R={},Ed=p,sc={},Mb=[],H={},Uc={},Xc=[],vc={},Tc=
k,Fd=k,Kb={},P={},Qe={},Bg={},Lg=0,Kd=p,Vd=[],ye={},cg={},Dg=p,mc=p,Cd=p,we=p,Nc={},Ib={},Qd={},Re={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Zc=p,Me=p,jc=q.HYPE_w_510,Ne=p,Oe=p;ca.Ya=rd;ca.ma=hd;var Ud=p,Rd=0,Sd=p,Wc=[];ca.z_o=function(){0==Lg&&(Lg=Jg());xd!=k&&xd(j,F);yd=yd&&w.ka!=k;Kb[B]=B;P[B]=B;Qe[B]=B;ja(F[O],A(v[0].Y));sa(F[O],A(v[0].Z));for(var a=0;a<v[J];a++){var b=v[a].T,c;for(c in b)if(b[K](c)!=p){var d=b[c];d.d=ad(d.z,d);for(var e=0;e<d.a[J];e++){var f=
d.a[e];f.t=ad(f.y,d);f.d=ad(f.z,d);f.p==k?f.p=0:2==f.p&&(f.d=0);f.r==k&&(f.r=p);f.k=e}e=d.b;for(f=0;f<e[J];f++){var h=e[f];h.startTime=ad(h.C,d);h.duration=ad(h.D,d)}}}Hg(ld);ek==j&&Hg(Mf);for(a=0;a<Of[J];a++)b=Of[a],c=y[Ta](hi),ka(c,b),Gg(c);q[lb](Ob,120);q[lb](Ob,1200);a=y[Ta](hi);a.id=bf;ra(a[O],gj);a[D](fh,j);F[ua](a);for(b=0;b<v[J];b++){c=v[b];d=y[Ta](hi);e=d[O];pa(d,cf);d.id=Pe(c.o,k,Ei);d[D](df,c.x);Qf!=p&&(e.backgroundColor=c.c);ra(e,gj);d[D](fh,j);e.overflow=zi;e.position=bh;ja(e,A(c.Y));
sa(e,A(c.Z));10<=w.oa&&(e.perspective=c.p);F[ua](d);var e=c.v,m;for(m in e)if(e[K](m)!=p&&(f=e[m],(h=f.cL)&&R[h]==k)){var n=c.T,s=[],l;for(l in n)if(n[K](l)!=p){var r=c.T[l],t=r.a;r.s==h&&(r=Jd(l,t,r,h),s[C](r))}n=y[Ta](f.k);pa(n,f.cP?$e+f.cP:Ye);n.id=Pe(m,f.i,Di);f.w!=k&&ka(n,f.w);if(w.ka!=k||10<=w.Ka)r=Ig(n,f,c.p),a[ua](r);else a[ua](n);R[h]={element:n,sb:s,xb:f.cS,mb:p,ib:[]}}s=c.O;for(t=0;t<s[J];t++)if(m=s[t],e[K](m)!=p&&(f=e[m],h=f.cL,!(f.cM==j||h))){n=y[Ta](f.k);pa(n,f.cP?Xe+f.cP:We);n.id=Pe(m,
f.i,Di);f.w!=k&&ka(n,f.w);var h=k,u;for(u in pb)if(pb[K](u)!=p){for(r=0;r<pb[u][J];r++)if(m==pb[u][r]){h=u;break}if(h!=k)break}w.ka!=k||10<=w.Ka?(r=Ig(n,f,c.p),h?R[h][Pb][ua](r):d[ua](r)):h?R[h][Pb][ua](n):d[ua](n)}}for(m=0;m<v[J];m++){l=v[m].T;for(var x in l)if(l[K](x)!=p){u=l[x].j;for(var E in u)if(u[K](E)!=p){a=u[E];b={};c=[];for(d=0;d<a[J];d++)e=a[d],c[C]({ua:{x:e[0],y:e[1]},Ga:{x:e[2],y:e[3]},Ba:{x:e[4],y:e[5]},Ja:{x:e[6],y:e[7]},length:0,ba:[]});b.la=c;oa(b,ze(c,j));ye[E]=b}}}for(var H in Re)Re[K](H)!=
p&&(wd[H]=Re[H]);for(var M in wd)if(wd[K](M)!=p){x=wd[M];E=[];for(H=0;H<x[J];H++)m=x[H],E[C]({ua:{x:m[0],y:m[1]},Ga:{x:m[2],y:m[3]},Ba:{x:m[4],y:m[5]},Ja:{x:m[6],y:m[7]},length:0,ba:[]});ze(E,p);cg[M]=E}for(var I in ha)ha[K](I)!=p&&(M=ha[I].g,M!=k&&(x=sc[M],x==k&&(x=[],sc[M]=x),x[C](I)));for(var L in ha)ha[K](L)!=p&&ha[L].p!=k&&-1==sb(Mb,L)&&Mb[C](L);I=Mb[Da](0);if(0==I[J])Ag();else for(L=0;L<I[J];L++)jk(I[L]);q[Ua]?(q[Ua](rj,function(){Zc=p;Ob()}),q[Ua](kj,function(){q[lb](Ob,1)})):q[bb]&&q[bb](jj,
function(){Zc=p;Ob()});Jc&&(F[O][jd]=uj,F[Ua]&&(F[Ua](ci,Pd,j),F[Ua](bj,Pd,j),F[Ua](Yi,Pd,j),F[Ua](aj,Pd,j)))};var w;var Ra=function(a){return(a=da&&da[ob]&&da[ob].match(a))&&a[1]},x={};if(da){x.oa=ga(Ra(/MSIE (\d+\.\d+)/))||k;x.yb=ga(Ra(/Gecko\/(\d+)/))||k;x.Ka=ga(Ra(/Firefox\/(\d+\.\d+)/))||k;x.ka=ga(Ra(/AppleWebKit\/(\d+\.\d+)/));x.Wa=ga(x.ka&&Ra(/Chrome\/(\d+\.\d+)/))||k;x.pb=ga(x.ka&&Ra(/Safari\/(\d+\.\d+)/)&&Ra(/Version\/(\d+\.\d+)/))||k;x.opera=ga(Ra(/Opera\/(\d+\.\d+)/)&&Ra(/Version\/(\d+\.\d+)/))||
Ra(/Opera\/(\d+\.\d+)/)||ga(x.ka&&Ra(/OPR\/(\d+\.\d+)/))||k;x.hb=-1<da[ob][Bb](je)||k;x.Ab=-1<da[ob][Bb](Fi)||k;x.Bb=-1<da[ob][Bb](Gi)||k;x.Cb=-1<da[ob][Bb](Hi)||k;x.ra=x.Ab||x.Bb||x.Cb||k;x.Db=y.compatMode==me||k;for(var Se in x)(x[Se]===k||isNaN(x[Se]))&&delete x[Se];x[Sa]&&x.oa&&delete x.oa}w=x;var De={i:Lc,cP:Lc,b:oc,a:oc,c:Ya,d:Ya,bQ:function(a){se(a)==j&&Mc(a)},bS:oc,t:function(a,b){a[O].fontSize=A(b)},s:function(a,b){a[O].fontFamily=b},v:function(a,b){a[O].fontWeight=b},u:function(a,b){a[O].fontStyle=
b},H:function(a,b){a[O].textDecoration=b},F:function(a,b){a[O].textAlign=b},G:function(a,b){a[O].color=b},X:function(a,b){a[O].letterSpacing=A(b)},E:function(a,b){a[O].wordSpacing=A(b)},Y:function(a,b){a[O].lineHeight=A(b)},aX:Xf,aW:Xf,f:nc,bR:Mc,aY:Mc,cQ:nc,cR:nc,tX:nc,tY:nc,bO:nc,bP:Lc,e:function(a,b){a[O].opacity=b;a[O].MozOpacity=b},aP:function(a,b){a[O].cursor=b},bD:function(a,b){a[O][ca.ma+Vj]=b;a[O].MozUserSelect=b;a.onselectstart=function(){return p}},N:function(a,b){a[O].borderLeftWidth=
...
typeof b!=hj?b:A(b);a[O].borderTopLeftRadius=b;a[O].MozBorderRadiusTopleft=b},aL:function(a,b){b=typeof b!=hj?b:A(b);a[O].borderTopRightRadius=b;a[O].MozBorderRadiusTopright=b},aI:function(a,b){b=typeof b!=hj?b:A(b);a[O].borderBottomLeftRadius=b;a[O].MozBorderRadiusBottomleft=b},aJ:function(a,b){b=typeof b!=hj?b:A(b);a[O].borderBottomRightRadius=b;a[O].MozBorderRadiusBottomright=b},bE:function(a,b){ka(a,W);var c=sc[b];if(c!=k)for(var d=0;d<c[J];d++){var e=c[d],f=ha[e].t,e=Wd(e),h=a.ownerDocument[Ta](Aj);
...
a[O].backgroundImage=c!=k?Uj+c+Cc:Uj+d[Ea](/'/g,zc)+Cc}},q:function(a,b){a[O].backgroundSize=b;a[O][ca.ma+Eh]=b;a[O].MozBackgroundSize=b},o:function(a,b){a[O].backgroundOrigin=b;a[O][ca.ma+Dh]=b;a[O].MozBackgroundOrigin=b},p:function(a,b){a[O].backgroundRepeat=b},x:function(a,b){a[O].overflow=b},aT:function(a,b){a[O].paddingLeft=A(b);Ya(a)},aU:function(a,b){a[O].paddingRight=A(b);Ya(a)},aV:function(a,b){a[O].paddingTop=A(b);Ya(a)},aS:function(a,b){a[O].paddingBottom=A(b);Ya(a)},S:Bd,T:Bd,R:Bd,Q:Bd,
bB:Ad,bC:Ad,bA:Ad,aZ:Ad,bL:function(a){Hb(a);w.Wa!=k&&a[O][kd]==W&&(a[O][kd]=gj)},bG:Hb,bH:Hb,bI:Hb,bJ:Hb,bK:Hb,BDbL:lc,BDbG:lc,BDbH:lc,BDbI:lc,BDbJ:lc,BDbK:lc,Z:function(a,b){a[O].wordWrap=b},yy:function(a,b){a[O].whiteSpace=b},y:function(a,b){a[O].whiteSpaceCollapsing=b},z:function(a,b){ma(a[O],b);a[Rb][kb]==af&&ma(a[Rb][O],b)},aA:function(a,b){var c=X(a,b.a);Jc&&(Lb(a,{Da:1,ca:Jj},c),a[O][jd]=uj);a[D](wj,Nh);Aa(ci,a,c,j)},aD:function(a,b){Aa(aj,a,X(a,b.a),p)},aC:function(a,b){Aa($i,a,X(a,b.a),
p)},aE:function(a,b){var c=X(a,b.a);Jc&&(Aa(Nj,a,c,j),a[O][jd]=uj);a[D](wj,Nh);Aa(bj,a,c,j)},aB:function(a,b){var c=X(a,b.a);if(Jc){var d=j;if(w.ra!=k)for(var e=b.a,f=0;f<e[J];f++)if(5==e[f].p&&e[f].k==j||w.ra!=k&&601.1<=ga(w.ka)&&12==e[f].p){d=p;break}d==j&&Aa(Pj,a,c,j);a[O][jd]=uj}a[D](wj,Nh);Aa(Yi,a,c,j)},bN:function(a,b){vg(a,b)},cW:function(a,b){Rf(a,X(a,b.a),qi)},cX:function(a,b){Rf(a,X(a,b.a),si)},cG:function(a,b){Lb(a,{Da:1,direction:vj,Oa:30,ca:Fj},X(a,b.a))},cH:function(a,b){Lb(a,{Da:1,
direction:Qi,Oa:30,ca:Fj},X(a,b.a))},cI:function(a,b){Lb(a,{Da:1,direction:Tj,Oa:30,ca:Fj},X(a,b.a))},cJ:function(a,b){Lb(a,{Da:1,direction:ii,Oa:30,ca:Fj},X(a,b.a))},cK:Lc,cF:Lc,aM:function(a,b){Aa(aj,a,qe(a,b),p);Aa($i,a,zd(a,b),p)},aN:function(a,b){Jc&&(Aa(Pj,a,qe(a,b),p),Aa(Oj,a,zd(a,b),p),Aa(Nj,a,zd(a,b),p),a[O][jd]=uj);Aa(Yi,a,qe(a,b),p);Aa(bj,a,zd(a,b),p)},V:re,U:re,W:re,w:function(a,b){ka(a,b);for(var c=a[hb](yj),d=0;d<c[J];d++)c[d].src==W&&(q.execScript||function(a){q.eval.call(q,a)})(c[d].text)},
...
(b[La](),c=y.createEvent(zf),c.initMouseEvent(b[ab],b.bubbles,b.cancelable,b.view,b.detail,b.screenX,b.screenY,b[ib],b[jb],b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,b.button,k),f.dispatchEvent(c))}};za(yf,c,a,j);za(bj,c,a,j);za(Yi,c,a,j);za(ci,c,a,j)}}},Ie={},xc=k;ca.API={kSceneTransitionInstant:1,kSceneTransitionCrossfade:2,kSceneTransitionSwap:3,kSceneTransitionPushLeftToRight:4,kSceneTransitionPushRightToLeft:5,kSceneTransitionPushBottomToTop:6,kSceneTransitionPushTopToBottom:7,kHypeGesturePhaseStart:Cj,
kHypeGesturePhaseMove:cj,kHypeGesturePhaseEnd:pi,kHypeGesturePhaseCancel:$h,documentName:function(){return L},documentId:function(){return B},sceneNames:Fg,currentSceneName:function(){return Wa[Nb].n},showSceneNamed:function(a,b,c){a=sb(Fg(),a);Gb(a,b,c)},showNextScene:Sf,showPreviousScene:Tf,playTimelineNamed:og,startTimelineNamed:og,goToTimeInTimelineNamed:function(a,b){var c=vb(b);c==k&&(c=Li);kc(a,c,p)},pauseTimelineNamed:function(a){a=vb(a);a==k&&(a=Li);rb(a,k)},continueTimelineNamed:function(a,
...
k)return k;var d=H[P[a.id]][c.HYP_r];return d!=k?d:c.HYP_s},functions:function(){return Pf},resourcesFolderURL:function(){return ic},relayoutIfNecessary:Ob,kDirectionForward:0,kDirectionReverse:1,currentTimeInTimelineNamed:function(a){a=vb(a);a==k&&(a=Li);return rc(a,j)},durationForTimelineNamed:function(a){var b=vb(a);b==k&&(b=Li);a=0;b=U(b);b!=k&&(a=S(b));return a},currentDirectionForTimelineNamed:function(a){a=vb(a);a==k&&(a=Li);a=U(a);var b=0;a!=k&&(b=a.$?1:0);return b},isPlayingTimelineNamed:function(a){var b=
vb(a);b==k&&(b=Li);a=p;b=U(b);b!=k&&(a=b.fa);return a},triggerCustomBehaviorNamed:Vf,getSymbolInstanceById:function(a){if(a!=k)return ub[P[a]]},getSymbolInstancesByName:sg}};q.HYPE==k&&(q.HYPE=q.HYPE_510,q.HYPE.documents={});var bk=[];q.HYPE_dtl_510!=k&&(bk=q.HYPE_dtl_510[Da](0));q.HYPE_dtl_510=[];for(var ck=0;ck<bk[J];ck++)bk[ck]();})();
